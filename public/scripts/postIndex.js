export default [
  ...
  },
  {
    ...
    content:
      " If you are an innocent graphic designer (a.k.a. mostly used to the web), print design might seem like a super scary and intimidating world. It is. When designing for print, you are bound to make mistakes as a beginner. There are just  too many  things to think about. But don't fret. The world of print design is also fascinating and deeply satisfying — just imagine holding your freshly printed [insert your project name] 😍 Get started, experiment, and welcome to the world of print design! (But try to avoid these mistakes if you can… 🤞) 1. Don't use RGB colors, design in CMYK.    The RGB colors you've been using (almost) all your life on screen are based on light. Red, Green and Blue lights are added together to reproduce other colors. However, your printer is much more limited and won't be able to reproduce all the colors you see on screen. It's because it has to mix the four CMYK inks (Cyan, Magenta, Yellow and Key) to obtain a new color. So what?  Make sure to select the CMYK color mode, when creating your artwork. And if possible, always base your color decisions on a physical CMYK or Pantone color chart. 2. Your images resolution is too low.    Simply inserting this super cool image you found on the web into your print design can often lead to disaster. If you don't want to get a very pixelated result, your image resolution should always be between 300 ppi (pixels per inch) and 400 ppi. So what?  Even if the image quality seems to look good on screen, it might not be the case in print. Always check that your artwork resolution is above the 300 ppi threshold. 3. You haven't thought about the bleed and quiet borders.    Need to print to the border very edge? Set up a  bleed  before creating your design. The bleed is an outer-margin that you set around your document borders. All the graphics that touch the borders will be slightly extended to the bleed limit, before being trimmed to the sheet size after print. Thanks to the bleed, you won't have any unwanted white border appearing along the edges of the artwork. The  quiet border  is a safety margin inside your document, where no essential elements — such as text or logo — should be placed. This border is necessary as the trimming process is not always precise and can cut off important information. So what?  Set up a bleed of 3–5 mm and a quiet border of 10–15 mm for a regular A4 paper. These limits should be adjusted to your printer and paper size. As a rule of thumb, the bigger the sheet, the wider the bleed / quiet border. 4. You don't really know how to use black.    You are writing down your copy, selecting black ⬛ as a text fill color and are ready to print! Well,  maybe not . Double-click on the black fill you used and check the CMYK code. It might be something like C75-M68-Y67-K90. Using all four inks to write in black can result in blurry text — and that's bad. What you really need is to use the following code: C0-M0-Y0-K100. However, when applied on a larger area that black tone will look almost grey. For best results, switch to a  rich black  by mixing several ink colors to get a darker tone. There is not one recipe, but try to use the C40-M30-Y30-K100 CMYK code for those large areas. So what?  Use a crisp black C0-M0-Y0-K100 for small text, and a rich black for large black areas C40-M30-Y30-K100. If possible, directly check with your printer what their specifications for rich black are. 5. Your characters are too thin.    Depending on your printer capacities, your very small and thin characters might not be printed at all. So be careful with fine hairlines and tiny text! Another common mistake is to use small text on a rich black background. The slight misalignment of printing plates might make your characters illegible. When you have white text over black, use a C0-M0-Y0-K100 simple black to avoid this possible blur 🏃‍♂️🏃‍♂️🏃‍♂️ So what?  Don't use tiny text in your artwork. 6pt character size is a good rule of thumb — even though it all depends on your typeface style! When using small white text over black, choose a C0-M0-Y0-K100 simple black. 6. Haven't proofread your file?    Yes, proofreading is boring. It is so easy to publish a blog post, notice a typo, and correct it afterwards. However, spelling mistakes are the worst in print design. When printing hundreds of posters, that small typo reproduced over and over again might not seem so trivial anymore 😨 So what?  Always and systematically proofread and review your artwork before sending it to the printer. As a designer, also check for spelling mistakes and typos even if you haven’t written the original copy. 7. You haven’t embedded your graphics and text.    Your artwork is looking good and ready for print. You are especially happy about this super fancy font that you’ve found on Creative Market! 💁‍♀️ Just sending your design for print (even in PDF format) is not always a good idea. In all probability, the printers you are working with won’t have that fancy font and some problems might occur — some characters might be replaced, or disappear altogether. Make sure to embed all fonts in your artwork, before sending it to your printer. Outlining any stroke in your artwork to convert them into shapes and flattening all your work layers are also good practices. So what?  Don’t forget to embed your fonts, outline your artwork strokes and flatten your layers. 8. You forgot about ink coverage.    To print an artwork using CMYK colors, your printer will use four plates of inks that combined together in dot patterns will make up an image. Your printer and paper will often have an ink coverage limit. For example, let’s say you apply a rich black C70-M70-Y70-K100 on a large area. That area ink coverage would amount to 70+70+70+100=310%. Most standard printers can handle an ink coverage of 260%. Going over this limit can result in quality problems and warped paper. So what?  Check with your printer what their ink coverage is, and make sure that the colors you use fit this limit. 9. You’ve been using the wrong format.    Are you about to export your artwork into PNG or GIF files for print? 😱 These formats were developed for screen only. They have a resolution that is too low for print, as well as a reduced color capacity. So what?  For best results, export your file into a PDF format before sending it to your printer. 10. You thought a hard-copy proof wasn’t necessary.    Getting a hard-copy proof from your printer is not always necessary. But the bigger your project is, the more critical it becomes to see a physical example of your work before printing 10,000 other copies. Also make sure to use your printer color chart if they have one! So what?  Get a hard-copy proof of your work and check with your client that everything is perfect before scaling up.  Alright, you now know the basics and are ready to go — all by yourself 🤧 Do your best {end-key}",
  },
  {
    id: 2,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      "    Bouldering illustration by Karolin Chen    Oh my, oh my. So I kind of took the decision to stop these weeknotes more than a year ago. Nowadays, I am slowly feeling the need to come back to them. I remember that they sometimes felt like chores, but they also helped to anchor me in the present. Well, in any case, I am giving this habit a second (or third/fourth?) chance. I'll keep on calling them weeknotes even though I am not really expecting to follow a strict schedule. Life peek  These last few weeks have been getting colder in Berlin. Tonight, we are expecting the temperature to drop under 0 °C. When we went bouldering this morning, we could see a thin layer of snow on cars and terrace tables. My routine of going bouldering in the early morning with friends, followed by pastries at   La Maison    1  , is still one of my great highlights. It will probably be the thing I'll miss the most when we'll move out of Berlin next February.  Otherwise, I finally completed my first ever D&#x26;D campaign last weekend — what an epilogue! I learned a lot, and we are ready to kick start the next campaign straight away. I still need to think about my character, but am excited to try to get inside the head of someone new. Read &#x26; Watched   Lives of the Mayfair Witches (1990)   What a ride! I finally finished reading this supernatural horror trilogy of +2000 pages. Honestly, I don't know how I did it. It was half fascinating, half disturbing. In the end, I wouldn't even particularly recommend it (the disturbing parts were too much for me). However, once you are caught up in the story, you cannot really stop as you  need  to know what happens next.  Adieu Bohème (2017)    Adieu Bohème  is a beautiful short-film that will leave you awed. As the film comes to an end, you realize that it was shot  and  broadcast live from the 6th basement of the Bastille Opera House. Outstanding and surreal performance. T(W)IL  To make some Italian-approved carbonara  A few weeks ago, we invited over some Italian friends for a wine-tasting and carbonara-making session. It was super fun to see them argue over the technicalities of making this very simple — oh but so controversial — dish. This is more or less the  recipe we followed  — even though they definitely didn't need a recipe. To lead-climb  Last weekend, Robin and I completed our lead climbing course at  Magic Mountain . It is actually not that complicated, but we did learn a number of safety habits that we'll need to integrate in the long term. The weight difference between Robin and I (about 40 kg) was also totally fine, as we learned to use the Ohm that was made for this specific reason. We'll go back to lead climbing by ourselves on Monday to keep practicing. {end-key}  Footnotes    Amazing French bakery in Berlin with a super nice staff  ↩   ",
  },
  {
    id: 10,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      "    Arcade Astronaut by Jordan Jenkins    Life peek  So, my life just took an unexpected turn on Friday morning. As usual, I started the day bouldering with friends. As I was doing a very non-dangerous move  1  , I slipped and fell on the side of my ankle with a lot of speed and strength. It hurt  a lot . Of course, we still had to follow up with our normal routine of getting breakfast first at a local café — because  priorities  — before taking any drastic decisions, like going to the doctor. Stuffed with pastries and coffee, Robin finally took me on a piggyback ride to the closest doctor. Diagnostic: a very badly sprained ankle and 4–6 weeks without sport. And that'd only be if the ankle was  not  fractured. Which luckily it was not.  2   Needless to say, a lot of my plans for this month have been reviewed after the  catastrophe . Fortunately, I have a local wine bar five minutes from home where we are welcomed like friends. It is nice to build these local connections in the place you live in, from the coffee shop waiter to the grocery lady. It makes me a bit sad to leave them behind once we'll move away from Berlin. Discovered  An immobilised kind of lifestyle calls for more quiet activities. Fortunately, the list of winners for this year  Interactive Fiction Competition  is out! I proceeded to play three games, which totaled to about 5–6 hours. The Absence of Miriam Lane   Sometimes people give pieces of themselves away. Sometimes they give too much and who they are wears thin. They become an absence. A hole in the world. And a terrible Light shines through.    The Absence of Miriam Lane   is a choice-based game  3  . The way it was implemented on its plaform is amazing. The black and white imagery, the soundtrack create a very atmospheric environment, in which you are enclosed until the end of the story  4  . A Long Way to the Nearest Star   A thief on the run from the galactic police finds refuge on an abandoned spaceship. A lonely ship AI finds unexpected company.  Similarly,   A Long Way to the Nearest Star   is a choice-based game. The use of the platform is not as creative, but definitely helps with the setting. The difference between your thoughts and the things you read on digital devices (usually the AI talking to you) are stylized perfectly. The game is also quite lengthy — if you are a slow player like me — and left me with this wonderful feeling of coming out of a very good and absorbing story. And Then You Come to a House Not Unlike the Previous One   Wander through an apparently infinite number of spooky mansions, solving a basic puzzle in each one.  Finally,   And Then You Come to a House Not Unlike the Previous One   is a parser-based game  5  . The official synopsis doesn't tell you much and actually hides the fact that the adventure actually  has a meaning . Starting this game, I was more or less ready to solve a hundred problems, one after the other. However you quickly realize that the story is more complex than that... T(W)IL  To make Knödel  One of the things that inspire me to cook at home is going to the restaurant, eating something delicious and being like: I want to know how to make this. Well, that happened just last week with  Knödel . A few days later, I had made a fresh batch of my own that was not bad at all. Basically, they felt like big gnocchi where you simply swap the potatoes for bread instead.  6   To make lasagna  Yay, lasagna! How come I had never tried before? Not sure, but I will definitely have another go at it very soon. It was much easier than I expected it to be, and the result is just so good! {end-key}  Footnotes    For those interested in the technicalities, it was one of those run along the wall on a long volume move. However, as I kept my eyes on the prize — the final hand hold — my foot just  missed  the volume at some point and I fell to the floor... 15 cm below.  ↩   But we found that out the long way around after sticking around in the emergency room for 7 hours, yay.  ↩   In choice-based game you click on existing links to make your decisions.  ↩   I lost the game, but it is still worth playing.  ↩   In parser-based games, you need to spell out your actions through specifc commands.  ↩   I feel like both Germans and Italians would kill me for saying that.  ↩   ",
  },
  {
    id: 12,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " In October, I got a super cool graphics tablet. I have been doodling on and off since then — and I should definitely try to create a habit around it. In any case, here are already a few experimental drawings.               {end-key}",
  },
  {
    id: 14,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      "    Yerevan night life at Kong Cocktail Bar by Sarah Mari Shaboyan    Life peek  What a week! Lots of new discoveries these last few days. For the first time, I climbed my first crag with Robin and a few people we met at our local bouldering club. So far, we had only been climbing indoors — what a change! I do feel a lot more queasy than indoors, afraid to fall. I am also climbing a lot less efficiently as I spend precious minutes trying out tons of different holds before settling on one. On the opposite side, it is really liberating to be able to reach for any hold you want and decide to use it. The weather was also perfect. We arrived around 1PM and immediately removed jackets and sweaters. It was so sunny that it felt like the start of summer. I also had my first car driving experience. I never learned to drive, but the region really demands it. So far, I just learned to start the car, and I finally realize how much coordination it requires! I'll try to get through my car driving lessons as fast as possible — let's see if I can manage to drive a car by the end of the year. Read &#x26; Watched  The second week after our arrival in France, we subscribed to the big library in Aubenas. I love French-speaking libraries, as Belgium and France have a strong comics / graphic novels culture. We used to live next to a library, where we would go every two days to refresh our graphic novel storage. Our current library being 30 minutes from home, we now go every two weeks only. Nevertheless, I am happy to come back to this forgotten routine.  La maison de la plage (2019)   By Séverine Vidal and Victor L. Pinel  La maison de la plage  —  The house on the beach  — is a beautiful graphic novel by Séverine Vidal (scenario) and Victor L. Pinel (drawings). It is really well structured and made me travel through time, with an old family house at its center. Pinel masterly uses lighting and colors in his drawings to create distinct atmospheres and give us a sense of time. At the end of the day, this graphic novel made me feel a lot of different emotions and I would highly recommend it.  Natsuko no Sake (1988)   By Akira Oze  Natsuko no Sake  is my first manga in a while! It is a real love letter to the Japanese tradition of brewing sake. So far, I am only two volumes in — there are six volumes in total. I quite like it, but do feel like some of the content has aged a bit — nice characters being very sexist, saying inapproppriate things, and so on. I am also not completely taken by the main character whom I find a bit annoying. But the good part is that you learn a lot about sake and the traditions that surround it. I would recommend this series to people interested in learning more about sake in an entertaining way.  Dans la combi de Thomas Pesquet (2017)   By Marion Montaigne In the same vibe as her other scientific vulgarization graphic novels, Montaigne does a great job explaining the astronaut life in  Dans la combi de Thomas Pesquet . We quickly realize that being an astronaut is not as glamourous as we may think. Reading this book makes you feel like you are visiting the secret NASA backstage — worth it! {end-key}",
  },
  {
    id: 21,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " I had my 31st birthday last week. It still feels a bit weird being completely past my twenties. Here, I am just still flailing around, trying to figure out life as I go. At least it's exciting. For the occasion, Robin and I took off to the Hérault department and explored it for a week. Robin currently has a slight knee injury, so we were a bit limited in our activities: no climbing, swimming or hiking, but plenty of eating, wine tasting, village hopping, and library browsing. Here are some highlights:  Morning start at the café in Saint-Jean-de-Buèges, warm sweater, hot coffee and croissant Truly stunning church in St-Guilhem-Le-Désert, pond with carps in the inner garden, warm and quiet light Twisting roads lined with plane trees, sun rays piercing through, long shadows White wine at a wine bar terrace in Sète, a plate of fresh oysters from the producer stall next door Sharing wine and a meal in Karima's flat in Montpellier, floor made of old flat stones Second-hand bookstore in Pézenas, old beautiful books about oddly specific topics A winemaker and his wife in Minerve, his hands still full of dirt from the vineyard as we are savoring the wine Ice cream and coffee in the church square of Sauve, a fresh breeze in the late afternoon light   We met several people on the way — always open, and friendly, often creative. From this short trip, I come back with the renewed motivation to make my own soap, knit something from A to Z, paint some more. Good thing that these are all winter-friendly activities. {end-key}",
  },
  {
    id: 34,
    directory: "Musings",
    ...
    content:
      "    What To Consider When Considering Data Vis Rules  by Lisa Charlotte Ros   Life peek: Wholesome feelings after work  Being in semi-lockdown in Berlin feels both fast and slow. Days resemble each other and night falls early. Yet, I feel like I have been doing a lot of new small exciting things lately — this Update being one of them. Week after week, there are always a few highlights worth mentioning. Work wise, this last week was pretty intense for me: lots of Black Friday-related emergencies (ugh, marketing agencies) and the confirmation of my promotion to Senior Designer. After hectic days at work, Robin and I did what was left for us in a city half in lockdown: go for a walk in the cold and drink Glühwein. It seems like every coffee shop, bakery and restaurant has now started making its own mulled wine. Some are fruitier, some are spicier, some are just cheaper. I love them all. I love the contrast between the hot spicy drink, the warm lights and the cold evening weather. It gives me wholesome feelings. Read &#x26; Watched   How to Be Great? Just Be Good, Repeatably (article, 2019)   Like many others, Steph Smith explains why building a  habit of progression  might be your best bet at becoming great. She defines it as a continuous effort, where inputs lead to expected outputs. In short:  If I were to continue this every day for the next year, would I be in a better place?   The Zettelkasten Method: Examples to help you get started. (article, 2020)   Rebecca Williams gives a clear and concise explanation to get started with the Zettelkasten Method — beginner friendly! Her step by step approach with concrete examples really helped me settle on a working note-taking system. Discovered   PaperSpan    Save articles in a few clicks and add highlights for free.  As I got more serious with my note-taking habit, I also needed a place to save what I read. My only requirement was unlimited highlights. Pocket and Instapaper felt a bit overpriced for my simple needs. I decided to opt for PaperSpan which does the job perfectly.  Newslettrs   A newsletter-dedicated inbox out of your email — beta mode. Robin was telling me that I have an early adopter personality. Newslettrs is one of those services I subscribed to less than 30 minutes after discovering them. I had enough of dividing my email inbox between work emails and newsletters — which I think require a completely different mindset. Separating them completely sounded like an ideal plan to me! Overheard   Not only is any sufficiently advanced technology indistinguishable from magic; any sufficiently advanced technologist seems like a magician. — Autotranslucence,  Becoming a magician   {end-key}",
  },
  {
    id: 35,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " It's the last day of 2022, 5.40 AM, and I can't seem to sleep anymore. A lot of thoughts are going through my mind. Most of them relate to our  move to France  in less than a month. I won't dive into the list of logistical to-dos that is keeping me awake. I'll go the other way around and take a snapshot in time. A snapshot of our time spent in Berlin and the things I'll miss from here.  Our morning bouldering routine with friends, climbing at 7 AM and going to  La Maison  for pastries The amazing Neapolitan pizza restaurants Getting our weekly groceries from  Herbie Unverpackt  and chatting with Carmela The extensive and delicious Turkish food offer in Neukölln The Middle Eastern breakfasts on Sonnenallee Being welcomed regulars at  La Vineria , our local wine bar Cycling everywhere Sunny lunches and coffee breaks by the Landwehr canal Playing chess or working at  Geschwister Nothaft Café  Reliving the Southeast Asian food stall experience at the Thai Park Cooling down in lakes in the summer Being max. 15 minutes walk from everything we love Weekend trips in Poland to eat pierogi The strong and friendly bouldering culture Beers and picnics at Tempelhofer Feld The carefree pace of life Playing table tennis in the streets on summer nights Always discovering cool new places to eat and drink The diverse mix of people playing pétanque in front of  La Maison  The super spicy Sichuanese restaurants Glühwein at Christmas markets And all the precious friends we've made on the way  I have forgotten many things, for certain. But as my friend Max said:  I am not crying, you are . Anyway. {end-key}",
  },
  {
    id: 44,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " I love the cleanliness and flexibility of vector illustration. But sometimes, it just feels…  too perfect . The grit and texture that come with raw sketches usually get lost translation. Today, I'll show you how to easily bring your creations to life with a crayon effect, using Adobe Illustrator only. Let's get started! 🚀   Before > after   Step 1  Open a copy of your original vector illustration in Adobe Illustrator. (Wouldn't want any accident happening, right? 😘) Step 2  Open the  Brushes  panel ( Window > Brushes ) and check  Show Art Brushes  in the panel menu.   Select your favorite brush!   Select the stroke you would like to convert into a crayon line, scroll down the brushes and choose your favorite one. (So many brushes! 🖌)   Repeat for all the vector strokes you'd like to convert into brush strokes.     Step 3  In this example, I'd like to add a brush stroke around the face to define it better. To do so, begin by making a copy of the face shape layer (here called skin).   Copy of the skin layer     Swap the swatches   With the layer selected, convert the shape into a stroke by swapping the Fill and Stroke swatches ( Shift + X ). You now have your outlining stroke! (Yaay 🎉) Feel free to edit the color and line weight to see it better. Step 4 (Optional)  Let's say you don't want your newly created stroke to completely outline the face shape (because that would just look weird). Let's see how we can manage to have a clear hairline at the top with ✂ Use the  Scissors  tool ( C ) to cut two endpoints on your stroke to delete that unwanted upper stroke.   ✂ Select endpoint #1…     …and endpoint #2     See? No more stroke!   Once you have your final stroke, convert it as previously done (Step 2) into a brush stroke. Step 5  Add some details to your illustration to bring it to life. Here, I've added definition to the hair and pink to the cheeks. And I got this flawless self-portrait as a result 💁‍♀️   So flawless.   Step 6  Before celebrating the creation of your masterpiece, convert your entire illustration to an outline ( Object > Path > Outline Stroke ). This will make sure that all the proportions stay the same, even if you scale your illustration up or down. (Yep, I'd rather stay the same size everywhere…)   Outlining makes sure to keep the proportions right.   And ta-da! 🎉   Good job guys 👍  ",
  },
  {
    id: 46,
    directory: "Musings",
    ...
    content:
      " À assumer ma singularité en m'habillant tout de noir Qu'un bon Döner est (1) pas cher, (2) à moins de 5 minutes de marche À traverser la route en moins de temps qu'il n'en faut pour dire  Kartoffelpuff-  À arrêter toute activité en cours pour profiter d'un rayon de soleil passager À boire une bière en marchant, en métro, à vélo Qu'en mars, une journée n'est pas complète si on n'a pas vu la neige, le ciel bleu et la grêle Quand manger des asperges (à tous les repas, tant qu'il y en a) Que seuls trois sports importent : le ping pong, la pétanque et le bloc Qu'en décembre, on fait le plein de Glühwein (faute de soleil) Où passer le meilleur Nouvel An : chez soi, les volets fermés Et bien sûr, à parler allemand : Hallo, ich möchte ein Schokocroissant bitte danke ciao {end-key}",
  },
  {
    id: 47,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " There is a new kid in town and its name is  duotone . You've certainly seen that refreshing effect used more than once this past year. The duotone effect consists of combining two contrasting colors in your image — one color for the dark tones and one color for the light tones. You can easily use this effect to strengthen a brand visual identity based on a few colors and get a vibrant result. Let's get started! 🚀   Before > after   Step 1  Choose a super cool image and open the  Layers  panel ( Window > Layers ). Click on the  Adjustment Layer  icon — the black and white circle thingy — and select  Gradient Map…    Gradient Map…> In the Layers panel, click on Adjustment Layer > Gradient Map…   Step 2  A gradient preview appears, click on it to open the  Gradient Editor . (The default gradient looks okay, but meh, it would just be waaay too easy 😘)   Click on the gradient preview.   Step 3  Here comes the fun part. Double-click on the left Color Stop to change its color. Do the same for the right Color Stop.  By default, the  left Color Stop  replaces the dark tones of your picture 🕶 The  right Color Stop  replaces the light tones ☀  Feel free to move the stops around to control the color distribution 🎨   And here is your duotone image! 🎉   Yay, you got your beautiful duotone image!   Step 4 (Optional)  Wanna get a bit crazy and go  triotone ? Add additional Color Stops to your gradient by clicking right underneath it. In this example, I've added a lighter blue in the middle of my gradient to give more definition to my picture.   You did it! 💁‍♀️   Triotone power! 💜💙🧡  ",
  },
  {
    id: 51,
    directory: "Musings",
    ...
    content:
      " Ça fait un moment que j'essaie de faire plus de projets créatifs. Il y a maintenant un an, j'étais tombée sur le Twitter de Kate Clanchy, une poète et enseignante anglaise. Elle a une approche à la poésie très vulgarisante, permettant à ses élèves de tout milieu de s'y mettre. J'ai commencé son livre  How to grow a poem  il y a quelques jours. Chaque chapitre est composé d'exercices très pratiques pour écrire différents poèmes. Je n'ai jamais vraiment fait de poésie, malgré le fait que plusieurs personnes de ma famille en ont beaucoup écrit (en vietnamien). Comme on dit, il n'est jamais trop tard, je me lance.  Dans la cabane  Un enfant encore rempli d'émerveillement Rentre dans sa cabane. En son centre, il met Ses jumelles, Son carnet de nuages, la première page commencée. Dans la cabane, il met les biscuits aux amandes de maman. Il y met son meilleur copain Célestin. Il ajoute son vélo rouge, les petites roues arrières, Puis finalement les enlève, il n'en a plus besoin. Il y met les découvertes qu'il a faites, Les fleurs qui s'endorment quand il pleut, Les fourmis qui marchent à la queue leu leu. À sa cabane, il ajoute le vieux squelette brun de tricératops visité au musée la semaine dernière avec l'école. À côté, le coprolite trouvé avec papy. Il y dépose ses pleurs avant le premier jour d'école, Et tout doucement, le bisou de Marie-Lou. (C'est son amoureuse.) Il fait de la place pour la navette spatiale qu'il construira quand il sera grand, Ses aventures d'explorateur de l'espace, Même celles où il aura au moins trente ans. Il les place toutes dans la cabane. Il y a déjà mis beaucoup de choses dans sa cabane. Mais elle est plus grande qu'elle n'en a l'air, Il pourra y mettre encore plus de choses demain. {end-key}  Texte inspiré du poème  Table  d'Edip Cansever. ",
  },
  {
    id: 52,
    directory: "Musings",
    ...
    content:
      "  Directed by Vàng Anh Phan Thi  This short of 33 minutes brought me right back in the streets of Hanoi. Through her lense, Vàng Anh Phan Thi shows us the reality of living in this small neighborhood. The speakers installation storyline felt almost like a backdrop to the daily lives of Thanh Công inhabitants. Rating: 4/5 {end-key}",
  },
  {
    id: 53,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      "   It's been a long time I had wanted to get a bit more familiar with digital drawing. I discovered the  Tayasui Sketches  software that was just what I needed: available on macOS, free to use, fast to learn, delivering great results out of the box. Above is one of the first doodles I made using that tool! {end-key}",
  },
  {
    id: 55,
    directory: "Musings",
    ...
    content:
      "  Directed by Jim Jarmusch  Not so much about the prison and crimes, than the encounter of three very different men that become friends. Rating: 4/5 {end-key}",
  },
  {
    id: 56,
    directory: "Musings",
  ...
  },
  {
    ...
    dateCreated: "2020-11-26",
    content:
      "  Directed by Elizabeth Chai Vasarhelyi and Jimmy Chin  One of the only times I had cold sweat during a film. Rating: 4/5 {end-key}",
  },
  {
    id: 58,
    directory: "Musings",
    ...
    content:
      " For many years, I have struggled with knowledge management — as I still do. I remember enthusiastically filling small cards a few years back when I first stumbled upon the  index card method  — or Zettelkasten. It never took off. A few years later, I discovered that this method had been adapted digitally by multiple different projects. I have a (too) early adopter personality and tried them all —  TiddlyWiki ,  Obsidian ,  Foam . Actually, I even mentioned it in a  weeknote  just last year. I realize that the problem doesn't lie in the tools and features, but being able to fully commit to a process. I tend to over-complicate things and not start as simple as I should. Building that new habit is then much harder, as the barrier to entry seems too high and complex. Currently, I am trying to not focus so much on the tool and its features, but on the note-taking habit itself. I recently created a super simple note-basket where I could record my evolving notes and thoughts on different topics. It exists without a publish button — in the sense that a note will be updated again and again without having a final version. So far, I try to not over-engineer it and not censor myself too much. No back-linking, predefined categories, or other must-have fancy features. I want to — will — build a solid habit first and add on top of it later. Anyway. {end-key}",
  },
  {
    id: 59,
    directory: "Musings",
  ...
  },
  {
    ...
    dateCreated: "2020-12-19",
    content:
      "  Directed by Martin McDonagh  Super funky characters, really liked the movie! Rating: 3.5/5 {end-key}",
  },
  {
    id: 61,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " Robin and I just realized that this is the first time in a month that we are back to being just the two of us. It feels great to spend long stretches of time with friends and create a new sort of routine together. However, the rhythm we are used to is also completely disrupted. We don't have as much time to talk or share the little things we usually do. After some time, it feels right to get back to our own little world. {end-key}",
  },
  {
    id: 64,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " Now in Berlin for more than two years with my partner  Robin . Summer here is great: I am bouldering a lot, drinking orange wine on sunny terraces, trying not to kill the kids screaming in the backyard (not mine — neither the kids nor the backyard),  baking bread  and making half-baked resolutions. But I spend most of my free time typing and clicking away on my laptop, working full-time as a graphic designer. {end-key}",
  },
  {
    id: 68,
    directory: "Musings",
    ...
    dateCreated: "2021-10-24",
    content:
      " Now in Berlin for more than two years with my partner  Robin . I am actively working on not being blown away by the wind and rain, and getting used to waking up in the dark. I boulder two or three times a week with friends — usually at 7am before going for pastries together. I am currently nurturing my very new  digital garden . For once, I am trying to  not over-complicate the process  to make the habit easier to build. As usual, I am reading sci-fi books. I finally started the  Dune series  after watching the recent movie by Villeneuve.  I needed to know what happened next!  I planted an avocado seed a few months back and finally gave it a name (Sigmund). It is now 55 cm tall and not dying — yet. Otherwise, I spend most of my free time typing and clicking away on my laptop, working full-time as a visual designer. {end-key}",
  },
  {
    id: 69,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " Still trying to find my marks in this new countryside life. I spend my free time:  Tending to the wood stove fire to heat the main living room Exploring the house Unpacking our boxes Planning and cooking meals Visiting neighbors and Robin's grandma for coffee (or wine) Reading graphic novels Thinking about post ideas for  Eau de poisson  {end-key} ",
  },
  {
    id: 73,
    directory: "Musings",
    ...
    content:
      " I am just starting my  early retirement parenthesis  — a.k.a, I am unemployed for the first time in four years. I do have a few productive plans for these next few months, but to be honest, I mostly want to slow down a bit and enjoy life differently. Currently, I spend most of my days:  reading sci-fi novels tending to the garden blogging here and  there  climbing outdoors and at my local gym working on a private Pocket alternative with Robin exploring new recipes doing small creative projects learning Typescript drinking wine with France {end-key} ",
  },
  {
    id: 74,
    directory: "Musings",
    ...
    dateCreated: "2023-07-12",
    content:
      " I am currently  slow living  in Ardèche and spending my days following my heart desires. Top of my mind at the moment:  Climbing, climbing, climbing (and learning new cool outdoor techniques) Working on a private Pocket alternative with Robin Learning about plants Reading Tending to my website Gardening and preserving food Planning our big 2024 trip {end-key} ",
  },
  {
    id: 75,
    directory: "Musings",
    ...
    dateCreated: "2020-11-26",
    content:
      "  Directed by Martin McDonagh  Completely crazy and over the top characters, dialogues are amazing. Loved how they mixed the screenplay and reality. Rating: 3.5/5 {end-key}",
  },
  {
    id: 76,
    directory: "Musings",
    ...
    content:
      " A list of things noticed during our 2-week trip in Sicily:  People saying bombastic Traffic rules seem to simply be suggestions (especially speed limits) Savory or sweet, everything is fried  Arancina  or  arancino , that is the question  1    Pani câ meusa  (or spleen sandwich) is surprisingly good Breakfast (when there is one) should be sweet Bread is yellow, not sure why  Cassata  might be one of the rare layered cake I like Recycling is going strong (or theoretically at least with all these different bins) So many stray cats A few stray dogs A carb with carb with carb sandwich  2   Clear turquoise water that are postcard-worthy The landscape looks similar to some parts of the Ardèche region in France (but as a drier version most of the time) Some people wearing winter jackets even though it's more than 25 °C A mix of overpopulated cities and lands only inhabited by cows and sheeps Olive trees Orange trees Lemon trees Fresh lemons that you can practically eat like apples Empty streets from 1–3pm, except for the occasional tourist A very strong pride in being Sicilian No one cares about the Italian national day Churches 24 hours vending machine clusters everywhere Lots of precise hand gestures Much more tourism than what I would have expected Very cool pebble beaches (sand is overrated) Toilets that flush with a manual tap system Terrible napkins that feel like paper Natural reserves where you can swim just like at a regular beach  3   A very poor public transportation system — the car is king An obsession with the Moor's heads  4   as: ceramic vases, book holders, tablecloth decoration, bed sheet pattern, pillow cases, magnets, mugs, ... Many archeological monuments (a.k.a. lots of protected old rocks that are expensive to see) Ficuses, my new favorite type of tree!  5   {end-key}   Footnotes    There is apparently a strong debate between West ( arancina  team) and East ( arancino  team) Sicily on how to call these delicious rice balls.  ↩   Thinking of the  panelle e crocchè  sandwich that is made with bread, chickpea fritters and fried potato balls  ↩   This feels weird to me, aren't natural reserves usually supposed to be protected from any kind of human impact?  ↩   The Moor's heads are symbolic of Sicily. The story is about an impossible love between a Moor young woman and a man. Spoiler: She cuts his head and makes a vase with it when she learns that he is married with kids. #romantic #truelove  ↩   The coolest ficus tree is in the Palermo botanical garden.  ↩   ",
  },
  {
    id: 77,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      "  Directed by M. Night Shyamalan  Really nice tension building all throughout the movie, amazing acting. Rating: 4/5 {end-key}",
  },
  {
    id: 79,
    directory: "Musings",
  ...
  },
  {
    ...
    dateCreated: "2020-12-05",
    content:
      "  Directed by Sergio Leone  It might not have helped that we watched the 3 hours version, but I was falling asleep by the end — it was very late. Amazing silences, staging and soundtrack otherwise. Rating: 3.5/5 {end-key}",
  },
  {
    id: 81,
    directory: "Musings",
  ...
  },
  {
    ...
    dateCreated: "2020-12-12",
    content:
      "  Directed by Bong Joon-ho  I had high-ish expectations and was finally a bit underwhelmed. Too over the top and kitsch for my tastes. Overall entertaining movie. Rating: 2.5/5 {end-key}",
  },
  {
    id: 83,
    directory: "Musings",
    ...
    content:
      "  Directed by Brian De Palma  Astonishing photography. Very conservative in its depiction of women and morals, but was it represented like that on purpose? Hard to tell in retrospect. Rating: 4/5 {end-key}",
  },
  {
    id: 84,
    directory: "Musings",
  ...
  },
  {
    ...
    content:
      " I started using Notion a bit more to keep living notes — posts that I want to access and update easily through time. Here are the ones I am keeping on my UI/UX learning journey.   UI Pattern Library   UX Theory  {end-key} ",
  },
  {
    id: 86,
    directory: "Musings",
    ...
    dateCreated: "2020-11-26",
    content:
      "  Directed by Sebastian Schipper  Tensed film, irritating main character. The amateur camera style literally gave me a headache. Rating: 3.5/5 {end-key}",
  },
  {
    id: 87,
    directory: "Musings",
    ...
    content:
      " 6.20 AM The last days were spent sorting four years of stuff, painting walls, and deep cleaning our flat. Between chores, we said goodbye to places and friends. These few morning hours (or minutes) awake will probably be the last we spend in Berlin as residents. So many memories, so many feelings — what a grand adventure it was! Next time I write will be from France. See you there! {end-key}",
  },
  {
    id: 88,
    directory: "Musings",
    ...
    dateCreated: "2020-12-26",
    content:
      "  Directed by Patty Jenkins  Needed to close my eyes from time to time because it was just too cheesy to witness. Entertaining anyway. Rating: 2.5/5 {end-key}",
  },
  {
    id: 89,
    directory: "Learning",
    title: "Nuages: Les différents types",
    slug: "/learning/.nuages-les-differents-types",
    dateCreated: "2023-11-27",
    content:
      " On compte un total de dix grands types de nuages. Ces types sont définis d'après leur forme, hauteur / constitution, dangerosité. 1. ",
  },
  {
    id: 90,
    directory: "Learning",
  ...
  },
  {
    ...
    content:
      " It's been a while  Data visualization handbook  by Juuso Koponen and Jonatan Hildén has been waiting on my book shelf. I started to go through it about a week ago and here are a few quotes that stayed with me. Notes before we start:  The page numbers I use are from the first edition (2020). Some quotes might only be understandable within context. ",
  },
  {
    id: 98,
    directory: "Learning",
    title: "Data viz: Introduction",
    slug: "/learning/data-viz-2-introduction",
    dateCreated: "2022-05-05",
    content:
      " Text v. data visualization   When should data be visualized, and when is text enough? In short, if something can be expressed just as clearly or even more clearly in words, visualization is unnecessary — sometimes even couterproductive. (p. 29)  Golden rule   [There is] one rule that an information designer should always follow: choose the clearest presentation method available. Disregard any other rules and guidelines we present in this book, when they are in conflict with this golden rule of information design. (p. 43)  Micro/macro reading   At its best, a visualization gives an overview of the topic quickly, but also rewards the reader who spends time exploring it in depth. (p. 43) ",
  },
  {
    id: 99,
    directory: "Learning",
    title: "Data viz: General principles of visualization design",
    slug: "/learning/data-viz-3-general-principles-of-visualization-design",
    dateCreated: "2022-05-05",
    content:
      " Focal points guide the eyes   With the use of focal points, the designer can introduce linear features into an open narrative structure. If it is important that specific elements be read before others, these elements should be highlighted visually so that the reader's gaze is drawn to them first. Highlighting key details is also justified by the fact that it makes it easy for the reader to understand which of the features in the graphic are the most essential. (p. 90)  Note: For instance, a big central image can act as a focal point. Integrate text and graphics   In an eye-tracking study conducted at Lund University, the subjects were presented with newspaper spreads that had identical content, with the text and graphics laid out in different ways. [...] The study also looked at an alternative,  integrated  layout, in which the graphic elements were placed withing the text column, so that the teext and graphics that are related in content were located close to each other. When a page was laid out like this, readers read both the body text and the related graphics. This solution places less cognitive strain on the readers, because they do not have to form mnemonic links between the text and the separate graphics. (p. 90)  Nominal v. ordinal scales   A nominal scale divides items into classes, the only relevant characteristic of which is that they are separate. They have no particular order or distance on the scale. Examples of such classes include nationality, profession, membership in a certain group, and so on. [...] Values on a nominal scale cannot be mathematically compared. [...] An ordinal scale differs from the nominal scale in that the classes have a rank order: the first to tenth income decile, the Likert scale (strongly agree, agree, etc.), a ranking in comparison or competition, a military rank, and so on. It is possible to determine the median value for items on an ordinal scale, and to calculate the difference between two rankings, but because the scale does not say anything about the  magnitude  of differences between classes, most other calculations are not meaningful. (p. 94) ",
  },
  {
    id: 100,
    directory: "Learning",
    title: "Grande-voie: Le matériel",
    slug: "/learning/grande-voie-1-le-materiel",
    dateCreated: "2023-10-01",
    content:
      " En juillet dernier, Robin et moi avons fait  notre première grande-voie . Cet après-midi, on va renouveler l'aventure avec un copain. On en profite pour se rafraîchir la mémoire niveau manips et équipement. Équipement nécessaire :  Une corde simple (ou doublée pour trois personnes) Une longe avec son mousqueton-à-vis (par personne) Assez de dégaines pour la voie (+ une dégaine pour le relai) Une sangle et son mousqueton (par personne) Un mousqueton primaire (par personne) Un reverso avec deux mousquetons (par personne) ",
  },
  {
    id: 101,
    directory: "Learning",
    title: "Grande-voie: Les manips au relai",
    slug: "/learning/grande-voie-2-les-manips-au-relai",
    dateCreated: "2023-10-01",
    content:
      " Se sécuriser soi-même   En arrivant au relai, insérer une dégaine dans la boucle ou plaquette qui va dans la direction de la voie (souvent la plus haute). Faire en sorte que le mousqueton inséré soit retourné pour que l'ouverture soit vers l'extérieur. Se vacher temporairement dans la dégaine (mousqueton supérieur). Annoncer VACHÉE à son second. Insérer un mousqueton-à-vis dans la seconde plaquette (ouverture vers l'extérieur). Faire passer la sangle dans ce mousqueton-à-vis — puis le visser — et dans la première dégaine (mousqueton supérieur). Tendre la sangle dans la direction d'où il me sera confortable d'assurer le second. Faire en sorte que la couture de la sangle soit proche du mousqueton avant de faire un noeud de huit à son bout. Idéalement, l'angle de la sangle ne devrait pas dépasser 45 degrés. Accrocher un mousqueton-à-vis (le primaire) au noeud de huit de cette sangle. Ajouter une longe molle au système en faisant un noeud de huit assez loin sur notre propre corde et le glisser dans la dégaine (mousqueton inférieur). Transférer la vache principale de la dégaine au primaire, réajuster sa longueur si nécessaire. À ce stade, bien vérifier que tous les mousquetons ont été vissés correctement.  Assurer son second   Ravaler la corde pour pouvoir assurer son second (prendre sec). Si le relai est plat et confortable, ravaler la corde en faisant un tas bien rangé à ses pieds. Si le relai est moins confortable, ravaler la corde en faisant des boucles sur notre pontet en le faisant passer une fois à gauche et une fois à droite en alternance. Commencer par des petites boucles qui s'agrandissent au fur et à mesure. Cela sert à éviter que la corde ne s'emmêle lorsque je la retournerai pour la passer à mon·a second. Accrocher le reverso sur le primaire à l'aide d'un mousqueton-à-vis. Faire passer la corde du grimpeur dans le reverso et la tenir en place grâce à un mousqueton-à-vis supplémentaire. Bien visser tous les mousquetons. Vérifier que le système d'assurage bloque correctement en tirant sur la corde du grimpeur. Lorsque je suis prête à assurer, annoncer DÉPART SUR LA [COULEUR] et assurer la montée en moulinette de mon·a second. À son arrivée, mon second, se vache sur le primaire et ajoute une vache molle sur la dégaine (mousqueton inférieur). Retirer le système d'assurage en défaisant le reverso et la corde lui passant en travers.  Transférer le système d'assurage   Reprendre les dégaines si nécessaire. Retourner la corde de mon pontet au pontet de mon second (petites boucles sur le dessus). Défaire ma vache molle. Le reverso étant toujours sur le primaire, faire passer ma corde dans le reverso et la tenir en place grâce à un mousqueton-à-vis supplémentaire. Prendre ma corde passant entre mon pontet et le reverso et la faire passer par la dégaine. C'est le point de renvoi qui me permet de tomber sur la dégaine et non sur mon second. Vérifier que tous les mousquetons soient bien visser. Demander à mon second de me prendre sec, retirer ma longe primaire et commencer à grimper. ",
  },
  {
    id: 102,
    directory: "Learning",
    title: "Making solid shampoo",
    slug: "/learning/making-solid-shampoo",
    dateCreated: "2023-10-16",
    content:
      " Yesterday, I tried making solid shampoo for the first time. Here is the rough recipe I followed. Ingredients:  50 g SCI (Sodium Cocoyl Isethionate) 15 g bhringaraj powder 17 g chaulmoogra oil 15 g rosmarin hydrolat Optional: 24 drops of essential oils (tea tree, lavender, lemon)  The list of ingredients looks more dauting than it really is, as most of these ingredients can be swapped to other alternatives (e.g. choose your own powder, oil, water-based solution, and essential oils). For instance, a super simple recipe (not tested though) would be something like SCI + a powder + coconut oil + water. Note about the SCI  Apparently, using solid shampoo only can be irritating for your scalp (because of the SCI). It is usually recommended to alternate with a liquid shampoo — which doesn't need SCI to keep it solid. SCI is also  not very ecologically friendly to produce . I will probably look into making some liquid shampoo as well in the future. Observations and potential improvements   So easy to make! Basically: mix everything in a  bain-marie  and knead your mixture by hand with the essential oils. Too many essential oil drops; I would bring it down to max 20 drops. Would mixing only the SCI with the oil first help to melt it completely? Using a solid spoon could help to break it down as well.   Update 20/10/23: I tested the shampoo and it works great — my hair feels very clean. I wonder if it might be a bit too basic though. Would mixing in some citric acid make it smoother to use? ",
  },
  {
    id: 103,
    directory: "Learning",
    title: "Middle dot",
    slug: "/learning/middle-dot",
    dateCreated: "2023-10-21",
    content:
      " Since I got back to writing in French in  Eau de poisson , I have started to use the middle dot more and more (for inclusive language). I finally found a simple shortcut that works with my French (US) keyboard on Ubuntu:  Compose key  +  .  +  - ",
  },
  {
    id: 104,
    directory: "Learning",
    title: "Nuages: Les bases",
    slug: "/learning/nuages-les-bases",
    dateCreated: "2023-11-27",
    content:
      " Qu'est-ce qu'un nuage ?  Un nuage est en météorologie une masse visible constituée initialement d'une grande quantité de gouttelettes d’eau (parfois de cristaux de glace associés à des aérosols chimiques ou des minéraux) en suspension dans l’atmosphère au-dessus de la surface d'une planète. Comment se forme un nuage ?  Prenez un volume d'air saturé de vapeur d'eau (invisible). Reroidissez cet air (a.k.a. la pression baisse), une partie de la vapeur d'eau présente dans l'air se condense, on voit apparaître un nuage. Un nuage peut se former de différentes façons :  Par convection : L'air saturé prend de l'altitude par convection. La pression diminue et il y a de donc plus de condensation et de nuages. Par soulèvement orographique : Un nuage peut aussi se former lorsque l'air saturé rencontre un relief (qui monte), suit sa courbe et se refroidit donc. Par contact avec une terre froide : Par exemple, lorsque l'air chaud et humide de la mer rencontre une côte froide. L'air se refroidit et se condence. Par soulèvement frontal : Un front d'air chaud rencontre un front d'air froid. Il se soulève et peut former des nuages.  La forme des nuages  La forme d'un nuage est surtout déterminée par la stabilité de l'air qui l'entoure.  Air ambiant stable : Une masse d'air, humide et plus chaude que l'air extérieur stable, va se soulever. Elle va monter et baisser en température jusqu'au moment où sa température va égaliser celle de l'air ambiant. Pas très haut en altitude, le nuage va donc s'arrêter de monter, s'affaisser, s'allonger pour former un nuage  stratiforme . Air ambiant instable : Une masse d'air, humide et plus chaude que l'air extérieur instable (forts mouvements d'air verticaux), va également se soulever. À la différence du premier cas, l'air ambiant instable va descendre en température plus rapidement en montant en altitude. La masse d'air a donc plus de chemin à parcourir pour atteindre un point d'équilibre des températures. Le nuage formé est bourgeonnant et  cumuliforme .  Les nuages stratiformes auront donc tendance à se former plus proches du sol, jusqu'à environ 7 km d'altitude. Les nuages cumuliformes peuvent quant à eux s'étendre verticalement jusqu'à environ 20 km d'altitude. Au bout du compte, la différence entre la formation de différents types de nuages ​​est due aux températures de condensation. Certains nuages ​​se forment à des températures plus élevées et d'autres à des températures plus basses. Plus la température de la formation est basse, plus le nuage sera épais. Certains types de nuages ​​produisent également des précipitations, d'autres non. Si la température est trop basse, le nuage qui se forme sera constitué de cristaux de glace.",
  },
  {
    id: 105,
    directory: "Learning",
    title: "Russian: Duolingoing",
    slug: "/learning/russian-1-duolingoing",
    dateCreated: "2023-09-29",
    content:
      " Sooo I've been Duolingoing Russian for approximately a month now. Compared to other Duolingo languages, the Russian course is really bad. For me, the main issue is that we are missing some grammar notes or simple explanations for each lesson. Well, the internet heard my plea and provided. The  Duonotes wiki offers context  for the Russian Duolingo course! I am going to review that wiki and copy-paste the parts I find interesting or would like to remember.",
  },
  {
    id: 106,
    directory: "Learning",
    title: "Russian: To be or not to be",
    slug: "/learning/russian-2-to-be-or-not-to-be",
    dateCreated: "2023-09-29",
    content:
      " Russian does not have articles, nor does it normally use the verb to be in the present tense. An em-dash is used instead of the verb to be between the two nouns. Example: МОККА — КОФЕ ~ a mocha is coffee",
  },
  {
    id: 107,
    directory: "Learning",
    title: "Russian: Cases, the basics",
    slug: "/learning/russian-3-cases-the-basics",
    dateCreated: "2023-09-29",
    content:
      " Russian has 6 cases: Nominative (subject), Accusative (direct object), Genitive (of something), Prepositional (place or topic), Dative (recipient, indirect object), Instrumental (means of action). Some nouns of foreign origin are indeclinable, i.e. all their forms are the same. This includes words like метро, Дженни or кафе.",
  },
  {
    id: 108,
    directory: "Learning",
    title: "Russian: To have",
    slug: "/learning/russian-4-to-have",
    dateCreated: "2023-09-29",
    content:
      " У  A  есть  B  ~ By  A  there is a  B . which is used to translate  A  has a  B . The owner (A) is in the Genitive case, while the subject (B) is in the Nominative case. Omit есть if the existence of the object is obvious or not the point. This is very typical for describing traits or a number of objects. This also applies when expressing temporary states and illnesses (She has a migraine).",
  },
  {
    id: 109,
    directory: "Learning",
    title: "Russian: You, you, you",
    slug: "/learning/russian-5-you-you-you",
    dateCreated: "2023-09-29",
    content:
      " Russian makes a distinction between ты, singular you, and вы, plural you (you all). The latter also doubles for polite you, with verbs also in plural.  Use ты with friends and your family members. Use вы with adult strangers, your teachers and in other formal interactions (at the store, the doctor's, the airport etc.). People use вы with those who are much older. Nobody is polite toward kids. ",
  },
  {
    id: 110,
    directory: "Learning",
    title: "Russian: About names",
    slug: "/learning/russian-6-about-names",
    dateCreated: "2023-09-29",
    content:
      " Patronyms  Russians have three names; their first name and their surname — just like you have — and a patronymic (отчество), which is based on their father's name. Male patronymic a end in -евич or -ович, while female patronymics end in -евна or -овна. A very common polite pattern is to use a person's first name and a patronymic: Иван Иванович, вы заняты? ~ Ivan Ivanovich (= son of Ivan), are you busy? Nicknames  Russian has a casual diminutive form for many common names. They are often used with some degree of affection: Иван→Ва́ня, Мария→Маша, Александр(Александра)→Са́ша, Евгений(Евгения)→Женя, Елена→Лена, Алексей→Лёша, Пётр→Петя Greeting phrases  Здравствуйте/Привет! ~ Hello! (polite/informal) Меня зовут Клаус. А тебя/Вас? ~ My name is Klaus. And you? (polite/informal)  [Mnemonic] зовут as z'oeufs vous, an egg with a name tag  Как вас/тебя зовут? ~ What is your name? (polite/informal) Очень приятно. ~ Very nice. as in Nice to meet you. Мне тоже. ~ Me too. as in Nice to meet you too. До свидания/Пока! ~ Goodbye! (polite/informal)",
  },
  {
    id: 111,
    directory: "Learning",
    title: "Russian: Frequent words",
    slug: "/learning/russian-7-frequent-words",
    dateCreated: "2023-10-02",
    content:
      " Not being super convinced by the Russian Duolingo course, I started through this Anki deck:  The Ultimate Guide to Russian – The Most Used 5000 Words . This is my first time using Anki, so let's see how it fares (or more like how I fare at it). I'll post some of the dumb mnemonics I think of on the way.",
  },
  {
    id: 112,
    directory: "Learning",
    title: "Russian: Hello",
    slug: "/learning/russian-8-hello",
    dateCreated: "2023-10-02",
    content:
      " Доброе утро! ~ Good morning!  [Mnemonic] утро as in autre. The start of another day.  Добрый день! ~ Good afternoon!  [Mnemonic] день as in day. The day is already well advanced (= afternoon).  Добрый вечер! ~ Good evening!  [Mnemonic] вечер starts with the ve of evening, чер as in cher. An expensive and luxurious evening night. ",
  },
  {
    id: 113,
    directory: "Learning",
    title: "Stop motion: First steps",
    slug: "/learning/stop-motion-first-steps",
    dateCreated: "2022-02-13",
    content:
      " Here are the learnings I have from my first  stop motion project :  Pay more attention to the little emotional gestures and details. Focus less on going from A to B and more on the little repetitive movements that make the object look alive. Be careful about not bumping the camera. Use tripod whenever possible. Make sure my body doesn't come in the light way and cause unexpected shadows. Think through the logistics for the complex moves first.  E.g. How am I going to make this jar gradually fall? It will avoid extra work remaking scenes.  Make sure the camera focus is correct to avoid bluriness. For one viewpoint, simulate the whole sequence first to make sure the scene layout is right and everything is where it should be. ",
  },
  {
    id: 114,
    directory: "Media",
  ...
  },
  {
    ...
    content:
      "  Sophie reflects on the shared joy and private melancholy of a holiday she took with her father twenty years earlier. Memories real and imagined fill the gaps between miniDV footage as she tries to reconcile the father she knew with the man she didn't. Source: TMDB ",
  },
  {
    id: 120,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  At a tiny Parisian café, the adorable yet painfully shy Amélie accidentally discovers a gift for helping others. Soon Amelie is spending her days as a matchmaker, guardian angel, and all-around do-gooder. But when she bumps into a handsome stranger, will she find the courage to become the star of her very own love story? Source: TMDB ",
  },
  {
    id: 121,
    directory: "Media",
    title: "And Then There Were None",
    slug: "/media/and-then-there-were-none",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/basara",
    dateCreated: "2021-01-01",
    content: " This might be my favorite manga of all times.",
  },
  {
    id: 123,
    directory: "Media",
    title: "Broken Earth trilogy",
    slug: "/media/broken-earth-trilogy",
    dateCreated: "2021-01-01",
    content:
      " Wowowow, this might be my favorite fantasy series ever!  A SEASON OF ENDINGS HAS BEGUN. IT STARTS WITH THE GREAT RED RIFT across the heart of the world's sole continent, spewing ash that blots out the sun. IT STARTS WITH DEATH, with a murdered son and a missing daughter. IT STARTS WITH BETRAYAL and long-dormant wounds rising up to fester. This is the Stillness, a land familiar with catastrophe, where the power of the earth is wielded as a weapon. And where there is no mercy. Source: Open Library ",
  },
  {
    id: 124,
    directory: "Media",
    title: "Can't We Talk About Something More Pleasant?",
    slug: "/media/cant-we-talk-about-something-more-pleasant",
  ...
  },
  {
    ...
    slug: "/media/captain-fantastic",
    dateCreated: "2021-01-01",
    content:
      "  A father living in the forests of the Pacific Northwest with his six young kids tries to assimilate back into society. Source: TMDB ",
  },
  {
    id: 126,
    directory: "Media",
    title: "Chroniques birmanes",
    slug: "/media/chroniques-birmanes",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
  ...
  },
  {
    ...
    dateCreated: "2021-01-01",
    content:
      "  A young girl discovers an idealized parallel universe behind a secret door in her new home, unaware that it contains a sinister secret. Source: TMDB ",
  },
  {
    id: 129,
    directory: "Media",
    title: "Django Unchained",
    slug: "/media/django-unchained",
    dateCreated: "2021-01-01",
    content:
      "  With the help of a German bounty hunter, a freed slave sets out to rescue his wife from a brutal Mississippi plantation owner. Source: TMDB ",
  },
  {
    id: 130,
    directory: "Media",
    title: "Do the Right Thing",
    slug: "/media/do-the-right-thing",
    dateCreated: "2021-01-01",
    content:
      "  Salvatore Sal Fragione is the Italian owner of a pizzeria in Brooklyn. A neighborhood local, Buggin' Out, becomes upset when he sees that the pizzeria's Wall of Fame exhibits only Italian actors. Buggin' Out believes a pizzeria in a black neighborhood should showcase black actors, but Sal disagrees. The wall becomes a symbol of racism and hate to Buggin' Out and to other people in the neighborhood, and tensions rise. Source: TMDB ",
  },
  {
    id: 131,
    directory: "Media",
  ...
  },
  {
    ...
    slug: "/media/everything-everywhere-all-at-once",
    dateCreated: "2022-12-01",
    content:
      "  An aging Chinese immigrant is swept up in an insane adventure, where she alone can save what's important to her by connecting with the lives she could have led in other universes. Source: TMDB ",
  },
  {
    id: 133,
    directory: "Media",
    title: "Ex Machina",
    slug: "/media/ex-machina",
    dateCreated: "2021-01-01",
    content:
      "  Caleb, a coder at the world's largest internet company, wins a competition to spend a week at a private mountain retreat belonging to Nathan, the reclusive CEO of the company. But when Caleb arrives at the remote location he finds that he will have to participate in a strange and fascinating experiment in which he must interact with the world's first true artificial intelligence, housed in the body of a beautiful robot girl. Source: TMDB ",
  },
  {
    id: 134,
    directory: "Media",
  ...
  },
  {
    ...
    directory: "Media",
    title: "Free Solo",
    slug: "/media/free-solo",
    dateCreated: "2021-01-01",
    content:
      " Cold sweats.  Follow Alex Honnold as he attempts to become the first person to ever free solo climb Yosemite's 3,000 foot high El Capitan wall. With no ropes or safety gear, this would arguably be the greatest feat in rock climbing history. Source: TMDB ",
  },
  {
    id: 137,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  Chris and his girlfriend Rose go upstate to visit her parents for the weekend. At first, Chris reads the family's overly accommodating behavior as nervous attempts to deal with their daughter's interracial relationship, but as the weekend progresses, a series of increasingly disturbing discoveries lead him to a truth that he never could have imagined. Source: TMDB ",
  },
  {
    id: 138,
    directory: "Media",
    title: "Gone Girl",
    slug: "/media/gone-girl",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/guillermo-del-toros-pinocchio",
  ...
  },
  {
    ...
    slug: "/media/half-of-a-yellow-sun",
    dateCreated: "2021-01-01",
    content:
      "  In 1960s Nigeria, Ugwu, a boy from a poor village, goes to work for Odenigbo, a radical university professor. Soon they are joined by Olanna, a young woman who has abandoned a life of privilege to live with her charismatic lover. Into their world comes Richard, an English writer, who has fallen for Olanna’s sharp-tongued sister Kainene. But when the shocking horror of civil war engulfs the nation, their loves and loyalties are severely tested, while their lives pull apart and collide once again in ways none of them could have imagined Source: Open Library ",
  },
  {
    id: 141,
    directory: "Media",
    title: "Harry Potter series",
    slug: "/media/harry-potter-series",
    dateCreated: "2021-01-01",
    content:
      " Childhood classics.  Rescued from the outrageous neglect of his aunt and uncle, a young boy with a great destiny proves his worth while attending Hogwarts School for Wizards and Witches Source: Open Library ",
  },
  {
    id: 142,
    directory: "Media",
  ...
  },
  {
    ...
    directory: "Media",
    title: "Hocus Pocus",
    slug: "/media/hocus-pocus",
    dateCreated: "2021-01-01",
    content:
      " Childhood classics, not sure how well it has aged though.  After 300 years of slumber, three sister witches are accidentally resurrected in Salem on Halloween night, and it is up to three kids and their newfound feline friend to put an end to the witches' reign of terror once and for all. Source: TMDB ",
  },
  {
    id: 145,
    directory: "Media",
    title: "Howl's Moving Castle",
    slug: "/media/howls-moving-castle",
    dateCreated: "2023-06-29",
    content:
      " Incredibly poetic, Miyazaki at his best.  Sophie, a young milliner is turned into an elderly woman by a witch who enters her shop and curses her. She encounters a wizard named Howl and gets caught up in his resistance to fighting for the king. Source: TMDB ",
  },
  {
    id: 146,
    directory: "Media",
    title: "Hunt for the Wilderpeople",
    slug: "/media/hunt-for-the-wilderpeople",
    dateCreated: "2021-01-01",
    content:
      "  Ricky is a defiant young city kid who finds himself on the run with his cantankerous foster uncle in the wild New Zealand bush. A national manhunt ensues, and the two are forced to put aside their differences and work together to survive. Source: TMDB ",
  },
  {
    id: 147,
    directory: "Media",
    title: "In the Mood for Love",
    slug: "/media/in-the-mood-for-love",
    dateCreated: "2023-09-20",
    content:
  ...
  },
  {
    ...
    directory: "Media",
    title: "Inception",
    slug: "/media/inception",
    dateCreated: "2021-01-01",
    content:
      "  Cobb, a skilled thief who commits corporate espionage by infiltrating the subconscious of his targets is offered a chance to regain his old life as payment for a task considered to be impossible: inception, the implantation of another person's idea into a target's subconscious. Source: TMDB ",
  },
  {
    id: 149,
    directory: "Media",
    title: "Interstellar",
    slug: "/media/interstellar",
    dateCreated: "2021-01-01",
    content:
      "  The adventures of a group of explorers who make use of a newly discovered wormhole to surpass the limitations on human space travel and conquer the vast distances involved in an interstellar voyage. Source: TMDB ",
  },
  {
    id: 150,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  During the 1980s, a failed stand-up comedian is driven insane and turns to a life of crime and chaos in Gotham City while becoming an infamous psychopathic crime figure. Source: TMDB ",
  },
  {
    id: 151,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  Four teenagers in detention discover an old video game console with a game they’ve never heard of. When they decide to play, they are immediately sucked into the jungle world of Jumanji in the bodies of their avatars. They’ll have to complete the adventure of their lives filled with fun, thrills and danger or be stuck in the game forever! Source: TMDB ",
  },
  {
    id: 152,
    directory: "Media",
    title: "Kill Bill",
    slug: "/media/kill-bill",
    dateCreated: "2021-01-01",
    content:
      "  An assassin is shot and almost killed by her ruthless employer, Bill, and other members of their assassination circle – but she lives to plot her vengeance. Source: TMDB ",
  },
  {
    id: 153,
    directory: "Media",
    title: "Kirikou and the Sorceress",
    slug: "/media/kirikou-and-the-sorceress",
    dateCreated: "2021-01-01",
    content:
      " Childhood classics.  Drawn from elements of West African folk tales, it depicts how a newborn boy, Kirikou, saves his village from the evil witch Karaba. Source: TMDB ",
  },
  {
    id: 154,
    directory: "Media",
    title: "Kubo and the Two Strings",
    slug: "/media/kubo-and-the-two-strings",
    dateCreated: "2021-01-01",
    content:
      "  Kubo mesmerizes the people in his village with his magical gift for spinning wild tales with origami. When he accidentally summons an evil spirit seeking vengeance, Kubo is forced to go on a quest to solve the mystery of his fallen samurai father and his mystical weaponry, as well as discover his own magical powers. Source: TMDB ",
  },
  {
    id: 155,
    directory: "Media",
    title: "La Horde de Contrevent",
    slug: "/media/la-horde-de-contrevent",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
  ...
  },
  {
    ...
    slug: "/media/la-quete-dewilan-series",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/le-grand-mechant-renard",
    dateCreated: "2021-01-01",
    content:
  ...
  },
  {
    ...
    directory: "Media",
    title: "Life of Pi",
    slug: "/media/life-of-pi",
    dateCreated: "2021-01-01",
    content:
      "  The story of an Indian boy named Pi, a zookeeper's son who finds himself in the company of a hyena, zebra, orangutan, and a Bengal tiger after a shipwreck sets them adrift in the Pacific Ocean. Source: TMDB ",
  },
  {
    id: 162,
    directory: "Media",
    ...
    dateCreated: "2021-12-01",
    content:
      " I am pretty sure I liked it, just because I love Loki's character.  After stealing the Tesseract during the events of “Avengers: Endgame,” an alternate version of Loki is brought to the mysterious Time Variance Authority, a bureaucratic organization that exists outside of time and space and monitors the timeline. They give Loki a choice: face being erased from existence due to being a “time variant” or help fix the timeline and stop a greater threat. Source: TMDB ",
  },
  {
    id: 163,
    directory: "Media",
    title: "Lord of the Flies",
    slug: "/media/lord-of-the-flies",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    dateCreated: "2021-01-01",
    content:
      "  Two strangers are drawn to a mysterious pharmaceutical trial that will, they're assured, with no complications or side-effects whatsoever, solve all of their problems, permanently. Things do not go as planned. Source: TMDB ",
  },
  {
    id: 165,
    directory: "Media",
    title: "Mary Poppins",
    slug: "/media/mary-poppins",
    dateCreated: "2021-01-01",
    content:
      " I just loved this movie as a child.  Mr Banks is looking for a nanny for his two mischievous children and comes across Mary Poppins, an angelic nanny. She not only brings a change in their lives but also spreads happiness. Source: TMDB ",
  },
  {
    id: 166,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  Leonard Shelby is tracking down the man who raped and murdered his wife. The difficulty of locating his wife's killer, however, is compounded by the fact that he suffers from a rare, untreatable form of short-term memory loss. Although he can recall details of life before his accident, Leonard cannot remember what happened fifteen minutes ago, where he's going, or why. Source: TMDB ",
  },
  {
    id: 167,
    directory: "Media",
    title: "Memoirs of a Geisha",
    slug: "/media/memoirs-of-a-geisha",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/metaphysique-des-tubes",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    directory: "Media",
    title: "Midsommar",
    slug: "/media/midsommar",
    dateCreated: "2021-01-01",
    content:
      " This is the kind of horror movie I'm into.  Several friends travel to Sweden to study as anthropologists a summer festival that is held every ninety years in the remote hometown of one of them. What begins as a dream vacation in a place where the sun never sets, gradually turns into a dark nightmare as the mysterious inhabitants invite them to participate in their disturbing festive activities. Source: TMDB ",
  },
  {
    id: 170,
    directory: "Media",
    title: "Moonrise Kingdom",
    slug: "/media/moonrise-kingdom",
    dateCreated: "2021-01-01",
    content:
      " My favorite Wes Anderson movie.  Set on an island off the coast of New England in the summer of 1965, Moonrise Kingdom tells the story of two twelve-year-olds who fall in love, make a secret pact, and run away together into the wilderness. As various authorities try to hunt them down, a violent storm is brewing off-shore – and the peaceful island community is turned upside down in more ways than anyone can handle. Source: TMDB ",
  },
  {
    id: 171,
    directory: "Media",
    title: "Mushi-Shi",
    slug: "/media/mushi-shi",
    dateCreated: "2021-01-01",
    content:
      "  Ginko, a Mushi master, travels from place to place researching the Mushi and helping people who are suffering because of it. Source: TMDB  Comfort anime series, relaxing, feel-good with a bit of magic.",
  },
  {
    id: 172,
    directory: "Media",
    title: "Nage libre",
    slug: "/media/nage-libre",
    dateCreated: "2021-01-01",
    content:
  ...
  },
  {
    ...
    directory: "Media",
    title: "Orphan black",
    slug: "/media/orphan-black",
    dateCreated: "2021-01-01",
    content:
      "  A streetwise hustler is pulled into a compelling conspiracy after witnessing the suicide of a girl who looks just like her. Source: TMDB ",
  },
  {
    id: 175,
    directory: "Media",
    title: "Our flag means death",
    slug: "/media/our-flag-means-death",
    dateCreated: "2022-09-01",
    content:
      "  After trading in the seemingly charmed life of a gentleman for one of a swashbuckling buccaneer, Stede Bonnet becomes captain of the pirate ship Revenge. Struggling to earn the respect of his potentially mutinous crew, Stede’s fortunes change after a fateful run-in with the infamous Captain Blackbeard. Stede and crew attempt to get their ship together and survive life on the high seas. Source: TMDB  Will I ever hate anything related to Taika Waititi? Mmh... not sure, no.  Our Flag Means Death  has just the right balance of funny and sad, light and dark. All the characters are amazing and the cast improv acting is just on point.",
  },
  {
    id: 176,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  All unemployed, Ki-taek's family takes peculiar interest in the wealthy and glamorous Parks for their livelihood until they get entangled in an unexpected incident. Source: TMDB ",
  },
  {
    id: 177,
    directory: "Media",
    title: "Reservation Dogs",
    slug: "/media/reservation-dogs",
    dateCreated: "2022-12-01",
    content:
      "  This comedy follows the exploits of four Indigenous teenagers in rural Oklahoma who steal, rob and save in order to get to the exotic, mysterious and faraway land of California. Source: TMDB ",
  },
  {
    id: 178,
    directory: "Media",
    title: "Schindler's List",
    slug: "/media/schindlers-list",
    dateCreated: "2021-01-01",
    content:
      "  The true story of how businessman Oskar Schindler saved over a thousand Jewish lives from the Nazis while they worked as slaves in his factory during World War II. Source: TMDB ",
  },
  {
    id: 179,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      " The TV series that got us all in love with Cumberbatch.  A modern update finds the famous sleuth and his doctor partner solving crime in 21st century London. Source: TMDB ",
  },
  {
    id: 180,
    directory: "Media",
    title: "Shutter Island",
    slug: "/media/shutter-island",
    dateCreated: "2021-01-01",
    content:
      "  World War II soldier-turned-U.S. Marshal Teddy Daniels investigates the disappearance of a patient from a hospital for the criminally insane, but his efforts are compromised by troubling visions and a mysterious doctor. Source: TMDB ",
  },
  {
    id: 181,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      " Once again, Pixar manages to steal my heart.  Joe Gardner is a middle school teacher with a love for jazz music. After a successful audition at the Half Note Club, he suddenly gets into an accident that separates his soul from his body and is transported to the You Seminar, a center in which souls develop and gain passions before being transported to a newborn child. Joe must enlist help from the other souls-in-training, like 22, a soul who has spent eons in the You Seminar, in order to get back to Earth. Source: TMDB ",
  },
  {
    id: 182,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  The true story of how the Boston Globe uncovered the massive scandal of child molestation and cover-up within the local Catholic Archdiocese, shaking the entire Catholic Church to its core. Source: TMDB ",
  },
  {
    id: 183,
    directory: "Media",
    title: "Still Life",
    slug: "/media/still-life",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/stories-of-your-life-and-others",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/stranger-things",
    dateCreated: "2022-01-01",
    content:
      "  When a young boy vanishes, a small town uncovers a mystery involving secret experiments, terrifying supernatural forces, and one strange little girl. Source: TMDB ",
  },
  {
    id: 186,
    directory: "Media",
    title: "Subaru series",
    slug: "/media/subaru-series",
    dateCreated: "2021-01-01",
    content:
      " This might be the manga that got me started on the manga path.  Chaque jour, à la fin des classes, Subaru prend le chemin de l'hôpital, où elle danse pour son frère, atteint d'une tumeur cancéreuse au cerveau. Lorsque ce dernier décède, la jeune femme traumatisée entreprend de devenir danseuse professionnelle, cet art étant pour elle le seul moyen d'extérioriser ses sentiments. Or, des cabarets aux grandes scènes, la route est longue ... Une intrigue bien ficelée mettant en scène des protagonistes au caractère bien trempé. Si quelques crises de larmes auraient pu être supprimées, le courage, la persévérance et le travail qu'effectue la jeune femme sur elle-même sont rendus avec une belle intensité, à la fois par des dialogues bien sentis et un gracieux coup de crayon faisant se mouvoir les corps avec souplesse. Source: Open Library ",
  },
  {
    id: 187,
    directory: "Media",
    title: "The Artist",
    slug: "/media/the-artist",
    dateCreated: "2021-01-01",
    content:
      "  Hollywood, 1927: As silent movie star George Valentin wonders if the arrival of talking pictures will cause him to fade into oblivion, he sparks with Peppy Miller, a young dancer set for a big break. Source: TMDB ",
  },
  {
    id: 188,
    directory: "Media",
    title: "The Beach",
    slug: "/media/the-beach",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
  ...
  },
  {
    ...
    slug: "/media/the-great-escape",
    dateCreated: "2021-01-01",
    content:
      "  The Nazis, exasperated at the number of escapes from their prison camps by a relatively small number of Allied prisoners, relocate them to a high-security 'escape-proof' camp to sit out the remainder of the war. Undaunted, the prisoners plan one of the most ambitious escape attempts of World War II. Based on a true story. Source: TMDB ",
  },
  {
    id: 191,
    directory: "Media",
    title: "The Great Gatsby",
    slug: "/media/the-great-gatsby",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
  ...
  },
  {
    ...
    dateCreated: "2021-01-01",
    content:
      "  Set in the 22nd century, The Matrix tells the story of a computer hacker who joins a group of underground insurgents fighting the vast and powerful computers who now rule the earth. Source: TMDB ",
  },
  {
    id: 197,
    directory: "Media",
    title: "The Murderbot Diaries",
    slug: "/media/the-murderbot-diaries",
    dateCreated: "2021-01-01",
    content:
      " So many books in this series that perfectly mixes sci-fi and comedy. Loved them all.  The series is about an artificial construct designed as a Security Unit, which manages to override its governor unit, thus enabling it to develop independence. It calls itself Murderbot, and likes to watch unrealistic soap operas. As it spends more time with some caring humans, it starts developing feelings that it does not care for. Source: Open Library ",
  },
  {
    id: 198,
    directory: "Media",
    title: "The Night Circus",
    slug: "/media/the-night-circus",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/the-omnivores-dilemma",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
  ...
  },
  {
    ...
    slug: "/media/the-power-of-the-dog",
    dateCreated: "2021-12-01",
    content:
      "  A domineering but charismatic rancher wages a war of intimidation on his brother's new wife and her teen son, until long-hidden secrets come to light. Source: TMDB ",
  },
  {
    id: 203,
    directory: "Media",
    title: "The Prestige",
    slug: "/media/the-prestige",
    dateCreated: "2021-01-01",
    content:
      "  A mysterious story of two magicians whose intense rivalry leads them on a life-long battle for supremacy -- full of obsession, deceit and jealousy with dangerous and deadly consequences. Source: TMDB ",
  },
  {
    id: 204,
    directory: "Media",
    title: "The Queen's Gambit",
    slug: "/media/the-queens-gambit",
    dateCreated: "2023-01-01",
    content:
      "  In a Kentucky orphanage in the 1950s, a young girl discovers an astonishing talent for chess while struggling with addiction. Source: TMDB ",
  },
  {
    id: 205,
    directory: "Media",
    title: "The Shawshank Redemption",
    slug: "/media/the-shawshank-redemption",
    dateCreated: "2021-01-01",
    content:
  ...
  },
  {
    ...
    slug: "/media/the-thirteenth-tale",
    dateCreated: "2021-01-01",
    content: "",
  },
  {
    ...
    slug: "/media/the-three-body-problem",
    dateCreated: "2021-01-01",
    content:
      "  Cixin Liu's trilogy-opening novel about first contact with aliens and the clandestine struggle with them over Earth's future, and its scientific progress in particular. Source: Open Library ",
  },
  {
    id: 208,
    directory: "Media",
    title: "The Truman Show",
    slug: "/media/the-truman-show",
    dateCreated: "2021-01-01",
    content:
      "  Truman Burbank is the star of The Truman Show, a 24-hour-a-day reality TV show that broadcasts every aspect of his life without his knowledge. His entire life has been an unending soap opera for consumption by the rest of the world. And everyone he knows, including his wife and his best friend, is really an actor, paid to be part of his life. Source: TMDB ",
  },
  {
    id: 209,
    directory: "Media",
    title: "The Wonderful Story of Henry Sugar",
    slug: "/media/the-wonderful-story-of-henry-sugar",
    dateCreated: "2023-10-05",
    content:
      " Wes Anderson directed four shorts based on stories by Roald Dahl. They are poetic, dark, magnificient and should be watched in one sitting.  The Wonderful Story of Henry Sugar The Swan The Rat Catcher Poison ",
  },
  {
    id: 210,
    directory: "Media",
    title: "Three Billboards Outside Ebbing, Missouri",
    slug: "/media/three-billboards-outside-ebbing-missouri",
    dateCreated: "2021-01-01",
    content:
      "  After seven months have passed without a culprit in her daughter's murder case, Mildred Hayes makes a bold move, painting three signs leading into her town with a controversial message directed at Bill Willoughby, the town's revered chief of police. When his second-in-command Officer Jason Dixon, an immature mother's boy with a penchant for violence, gets involved, the battle between Mildred and Ebbing's law enforcement is only exacerbated. Source: TMDB ",
  },
  {
    id: 211,
    directory: "Media",
    title: "Triangle of Sadness",
    slug: "/media/triangle-of-sadness",
    dateCreated: "2022-12-01",
    content:
      "  A celebrity model couple are invited on a luxury cruise for the uber-rich, helmed by an unhinged, alcoholic captain. What first appears Instagrammable ends catastrophically, leaving the survivors stranded on a desert island in a struggle of hierarchy. Source: TMDB ",
  },
  {
    id: 212,
    directory: "Media",
    ...
    dateCreated: "2021-01-01",
    content:
      "  WALL·E is the last robot left on an Earth that has been overrun with garbage and all humans have fled to outer space. For 700 years he has continued to try and clean up the mess, but has developed some rather interesting human-like qualities. When a ship arrives with a sleek new type of robot, WALL·E thinks he's finally found a friend and stows away on the ship when it leaves. Source: TMDB ",
  },
  {
    id: 213,
    directory: "Media",
    title: "WandaVision",
    slug: "/media/wandavision",
    dateCreated: "2021-12-01",
    content:
      " One of the best series of the Marvel universe.  Wanda Maximoff and Vision — two super-powered beings living idealized suburban lives — begin to suspect that everything is not as it seems. Source: TMDB ",
  },
  {
    id: 214,
    directory: "Media",
    title: "What We Do in the Shadows",
    slug: "/media/what-we-do-in-the-shadows",
    dateCreated: "2021-01-01",
    content:
      " My first Waititi movie! He just knows how to make me laugh.  Vampire housemates try to cope with the complexities of modern life and show a newly turned hipster some of the perks of being undead. Source: TMDB ",
  },
  {
    id: 215,
    directory: "Media",
    title: "Wizard of Oz",
    slug: "/media/wizard-of-oz",
    dateCreated: "2021-01-01",
    content:
      " Childhood classics.  Young Dorothy finds herself in a magical world where she makes friends with a lion, a scarecrow and a tin man as they make their way along the yellow brick road to talk with the Wizard and ask for the things they miss most in their lives. The Wicked Witch of the West is the only thing that could stop them. Source: TMDB ",
  },
  {
    id: 216,
    directory: "Media",
    title: "World of Tomorrow",
    slug: "/media/world-of-tomorrow",
    dateCreated: "2021-01-01",
    content:
      "  A little girl is taken on a mind-bending tour of her distant future. Source: TMDB15 ",
  },
  {
    id: 217,
    directory: "Media",
    title: "Years and Years",
    slug: "/media/years-and-years",
    dateCreated: "2021-01-01",
    content:
      "  As Britain is rocked by unstable political, economic and technological advances, members of the Lyons family converge on one crucial night in 2019. Over the next 15 years, the twists and turns of their everyday lives are explored as we find out if this ordinary family could change the world. Source: TMDB ",
  },
  {
    id: 218,
    directory: "Media",
    title: "Yotsuba&! series",
    slug: "/media/yotsuba-series",
    dateCreated: "2021-01-01",
    content:
      " Wholesome and hilarious.  Yotsuba&#x26;! is centered on Yotsuba Koiwai, a five-year-old girl who is energetic, cheerful, curious, odd, and quirky — so much so that even her own father calls her unusual. She is also initially ignorant about many things that a child her age would be expected to know — among them doorbells, escalators, air conditioners, and even playground swings. This naïveté is the premise of humorous stories whereby which she learns about — and frequently misunderstands — everyday things. Source: Wikipedia ",
  },
  {
    id: 219,
    directory: "Recipes",
  ...
  },
  {
    ...
    slug: "/recipes/asparagus-and-baked-potatoes",
    dateCreated: "2022-06-18",
    content:
      " 5 pommes de terre, 1 botte d'asperges blanches, 1 poignée de noix ou amandes, Miel, Gros sel, Flocons de piment",
  },
  {
    id: 221,
    directory: "Recipes",
    title: "Banana bread",
    slug: "/recipes/banana-bread",
    dateCreated: "2021-02-05",
    content:
      "This is a recipe that Niamh recommended to me. And as with most dessert recipes, she was spot on. Definitely one of the best banana breads I have eaten. It has a very strong banana taste, is moist in the inside, but crispy on the outside. 115 g butter, cut into chunks, 160 g brown sugar, 5 medium-large mashed bananas, 2 large eggs, 1 tsp salt, 1.5 tsp ground cinnamon, 0.5 tsp ground nutmeg, 260 g flour, 1 tsp baking soda (Natron), >100 sourdough starter (or 1 tsp baking powder)",
  },
  {
    id: 222,
    directory: "Recipes",
    title: "Banana ice cream",
    slug: "/recipes/banana-ice-cream",
    dateCreated: "2023-06-30",
    content: " 5 bananes bien mûres, Un peu de crème, de lait ou de yaourt",
  },
  {
    id: 223,
    directory: "Recipes",
    title: "Basic millet",
    slug: "/recipes/basic-millet",
    dateCreated: "2022-10-06",
    content: " 200 g de millet (environ une tasse), 500 g d'eau",
  },
  {
    id: 224,
    directory: "Recipes",
    title: "Beetroot carpaccio",
    slug: "/recipes/beetroot-carpaccio",
    dateCreated: "2023-03-09",
    content: " 1 beetroot, Olive oil, Flaked salt",
  },
  {
    id: 225,
    directory: "Recipes",
    title: "Bell pepper spread",
    slug: "/recipes/bell-pepper-spread",
    dateCreated: "2022-10-31",
    content:
      " 1 bell pepper sliced in 8 pieces, 1 large handful of fresh herbs (e.g. cilantro, parsley, etc.), Olive oil, Salt, Lemon or vinegar",
  },
  {
    id: 226,
    directory: "Recipes",
    title: "Brazilian crispy smashed potatoes",
    slug: "/recipes/brazilian-crispy-smashed-potatoes",
    dateCreated: "2022-10-06",
    content: " 20 small potatoes, 2 tbsp olive oil, 1.5 tsp salt",
  },
  {
    id: 227,
    directory: "Recipes",
    title: "Brownies",
    slug: "/recipes/brownies",
    dateCreated: "2021-03-24",
    content:
      " 110 g butter melted and cooled, 200 g sugar, 2 large eggs, 25 g all-purpose flour, 60 g cocoa powder, 1 pinch salt, 1 pinch baking powder",
  },
  {
    id: 228,
    directory: "Recipes",
    title: "Bulgarian national salad (shopska)",
    slug: "/recipes/bulgarian-national-salad",
    dateCreated: "2022-11-12",
    content:
      "I was introduced to this super simple salad recipe when traveling in Eastern Europe. A similar recipe exists in multiple of those countries, and always stars three main ingredients: cucumbers, tomatoes and feta. From there, everything else is optional. 1 cucumber, diced, 3 tomatoes, diced, 1 feta cheese, diced",
  },
  {
    id: 229,
    directory: "Recipes",
    title: "Chinese chili oil",
    slug: "/recipes/chinese-chili-oil",
    dateCreated: "2022-04-29",
    content: " 2 cups of neutral oil, 1 cup or less of chili flakes",
  },
  {
    id: 230,
    directory: "Recipes",
    title: "Clafoutis",
    slug: "/recipes/clafoutis",
    dateCreated: "2023-07-18",
    content:
      "Recette d'un vieux bouquin de cuisine de France. 500 g de fruits avec leurs noyaux (cerises, mirabelles, prunes, baies), 1 cuillère à soupe bombée de farine, 65 g de sucre, 1 pincée de sel, 120 g (12 cl) de lait, 2 oeufs",
  },
  {
    id: 231,
    directory: "Recipes",
    title: "Cleaning spray for everything",
    slug: "/recipes/cleaning-spray-for-everything",
    dateCreated: "2023-02-13",
    content:
      " Bouteille à sprayer de 500 ml, 1,5 c-à-c. bicarbonate de soude, Eau chaude, 2 c-à-c. vinaigre blanc, 15–20 gouttes d'huiles essentielles (e.g. citron, eucalyptus, pin sylvestre)",
  },
  {
    id: 232,
    directory: "Recipes",
    title: "Cold spicy noodles",
    slug: "/recipes/cold-spicy-noodles",
    dateCreated: "2023-08-25",
    content:
      " Wheat noodles, 4–6 tbsp oil, 2–3 tbsp gochugaru, 2 tbsp sesame seeds, 2 garlic cloves, cut small, 2 tsp honey, 2–3 tbsp soy sauce, 2 tbsp white vinegar, 3–4 tbsp sesame or peanut paste, 2+ tbsp water, Cucumber, fresh out of the fridge and julienned",
  },
  {
    id: 233,
    directory: "Recipes",
    title: "Couscous",
    slug: "/recipes/couscous",
    dateCreated: "2023-10-29",
    content:
      "Recette de couscous de Souad, préparée ensemble pour la première fois à Joux en octobre 2023. Il fait légèrement frais dehors, on allume le poêle et on mange tous et toutes du même plat. Autour de la table : France, Souad, Greg, Karima, Thibaud, Robin et moi. Huile d'olive, 1 kg de semoule de blé, 600 g d'eau froide, salée, 2–3 oignons, Persil, Pois-chiches, trempés la veille, 2 boîtes de tomates, 1 petit pot de concentré de tomate, 1 petit verre de vin rouge, Ras el hanout, Sel et poivre, Légumes cuisson lente : carottes, navets, aubergine (coupés en gros morceaux), Légumes cuisson rapide : courgettes, poivrons (coupés en gros morceaux), Épaule d'agneau coupée en gros morceaux, Cuisses de poulet, Merguez",
  },
  {
    id: 234,
    directory: "Recipes",
    title: "Crispy oven fries",
    slug: "/recipes/crispy-oven-fries",
    dateCreated: "2022-04-07",
    content:
      " 4 large dry and mealy Russet Potatoes, 1 tbsp vinegar, 4 tbsp peanut oil, Coarse salt",
  },
  {
    id: 235,
    directory: "Recipes",
    title: "Croûtons",
    slug: "/recipes/croutons",
    dateCreated: "2023-04-20",
    content: " Old bread, 2 tbsp olive oil, Salt, 1 garlic clove, pressed",
  },
  {
    id: 236,
    directory: "Recipes",
    title: "Dumpling soup with egg whites",
    slug: "/recipes/dumpling-soup-with-egg-whites",
    dateCreated: "2022-11-08",
    content: " 3 egg whites",
  },
  {
    id: 237,
    directory: "Recipes",
    title: "Eggplant tarte tatin",
    slug: "/recipes/eggplant-tarte-tatin",
    dateCreated: "2023-07-29",
    content:
      "I love tarte tatin. This recipe is Asian-inspired and just hits the right spots for me. 2 eggplants, 3+ tbsp vegetable oil, 4 tbsp rice vinegar, 6 tbsp soy sauce, 4 tbsp caster sugar, 3 tbsp water, 5 cm piece fresh ginger, peeled and finely grated, 2 green chilies, finely sliced (or flaked chili), 2 garlic cloves, peeled and finely sliced, 1 pie dough, Juice of 1 lime",
  },
  {
    id: 238,
    directory: "Recipes",
    title: "Eggplants with a tahini-miso sauce",
    slug: "/recipes/eggplants-with-tahini-miso",
    dateCreated: "2023-09-27",
    content:
      " 2 medium eggplants, 1.5 tbsp chili powder, 1.5 tbsp smoked paprika, 1.5 tsp sugar, 1 tsp salt, 1/4 cup olive oil",
  },
  {
    id: 239,
    directory: "Recipes",
    title: "Endive pie",
    slug: "/recipes/endive-pie",
    dateCreated: "2022-11-12",
    content:
      " Dough for one pie, 3–4 endives, 1 apple, thinly sliced, 1 tsp sugar, 20 cl. milk, 1 egg",
  },
  {
    id: 240,
    directory: "Recipes",
    title: "Fennel salad",
    slug: "/recipes/fennel-salad",
    dateCreated: "2022-06-06",
    content:
      " 1–2 fennel bulbs, thinly sliced, 1 tbsp mustard, 1 tbsp olive oil, 2 tbsp balsamico vinegar (or replace half with apple cider vinegar)",
  },
  {
    id: 241,
    directory: "Recipes",
    title: "Fig pie",
    slug: "/recipes/fig-pie",
    dateCreated: "2023-09-01",
    content:
      " Figues, 100 g d'amande en poudre (ou noix, noisette), 40 g de sucre, 40 g de beurre, 1 oeuf",
  },
  {
    id: 242,
    directory: "Recipes",
    ...
    dateCreated: "2023-08-08",
    content:
      "L'une des premières recettes que j'ai appris à faire petite. 0.5 l de lait, 50 g de sucre, 3 oeufs",
  },
  {
    id: 243,
    directory: "Recipes",
    title: "Freeze spinach leaves",
    slug: "/recipes/freeze-spinach-leaves",
    dateCreated: "2023-06-14",
    content:
      "It is currently full spring-summer here in Ardèche. We have a lot of amaranth plants growing as weeds among our garden vegetables. Instead of discarding them, the leaves are great to use as an alternative to spinach. Here is a good way to store them for winter. Lots of spinach leaves (or leaves from other similar plants), Ice cubes",
  },
  {
    id: 244,
    directory: "Recipes",
    title: "Fresh cheese",
    slug: "/recipes/fresh-cheese",
    dateCreated: "2019-01-27",
    content: " 1 l milk, 1.5 tbsp white vinegar",
  },
  {
    id: 245,
    directory: "Recipes",
    title: "Gaspacho",
    slug: "/recipes/gaspacho",
    dateCreated: "2023-07-30",
    content:
      " 6 tomates mûres, 2 poivrons, 2 oignons, 1 concombre, 1 gousse d'ail, 6 c.à.s de vinaigre, 1/2 verre d'huile d'olive, piment en poudre, poivre et sel",
  },
  {
    id: 246,
    directory: "Recipes",
    title: "German Sauerkraut",
    slug: "/recipes/german-sauerkraut",
    dateCreated: "2022-03-06",
    content: " 4 tsp salt, 1 tsp fennel seeds, 1 tsp black pepper",
  },
  {
    id: 247,
    directory: "Recipes",
    title: "German sweet red cabbage",
    slug: "/recipes/german-sweet-red-cabbage",
    dateCreated: "2022-10-06",
    content:
      " 1 small head of red cabbage, 1 cup apple cider vinegar, 1.5 cups water, 1/3 cup sugar, 8 cloves",
  },
  {
    id: 248,
    directory: "Recipes",
    title: "German Tyrolean Knödel",
    slug: "/recipes/german-tyrolean-knoedel",
    dateCreated: "2022-12-04",
    content:
      " 200 g dry bread cubes (white part only), 2 eggs, 180 g milk (or water), 180 g spicy mountain cheese, 150 g butter, Salt, pepper, nutmeg",
  },
  {
    id: 249,
    directory: "Recipes",
    title: "Greek tzatziki",
    slug: "/recipes/greek-tzatziki",
    dateCreated: "2023-04-27",
    content:
      " 1 cucumber, 4 to 5 garlic cloves, minced, 1 tsp white vinegar, Olive oil, 2 cups plain yogurt, strained (or thick greek yogurt)",
  },
  {
    id: 250,
    directory: "Recipes",
    title: "Green tomato chutney",
    slug: "/recipes/green-tomato-chutney",
    dateCreated: "2022-10-06",
    content:
      " 1 kg green tomatoes, 1 kg red onions, 150 g raisins (or similar dried fruits), 2 tsp salt, 500 g sugar, 1 liter malt, mix A (3/4 cider vinegar, 1/4 balsamic vinegar) or mix B (50:50 rice and balsamic vinegar)",
  },
  {
    id: 251,
    directory: "Recipes",
    title: "Hollandaise sauce",
    slug: "/recipes/hollandaise-sauce",
    dateCreated: "2023-02-04",
    content:
      " 1 jaune d'oeuf, 1 cuillère à café d'eau froide, 65 g de beurre (ou compléter avec de l'huile d'olive), Jus de citron (ou vinaigre de cidre), Poivre, Sel",
  },
  {
    id: 252,
    directory: "Recipes",
    ...
    dateCreated: "2023-04-27",
    content:
      " 1 cup dry chickpeas, 1–2 garlic cloves, 1/3 cup tahini, 1 lemon, juiced, Salt, Olive oil",
  },
  {
    id: 253,
    directory: "Recipes",
    title: "Immunity shots",
    slug: "/recipes/immunity-shots",
    dateCreated: "2023-11-17",
    content:
      "Prepare these frozen immunity shots early winter to be ready for the cold season. 10 cm fresh ginger, 5 cm fresh tumeric, 2 lemons, roughly peeled, 2 oranges, roughly peeled, Black pepper (anti-inflammatory), Honey",
  },
  {
    id: 254,
    directory: "Recipes",
    title: "Indian dal tadka",
    slug: "/recipes/indian-dal-tadka",
    dateCreated: "2020-12-24",
    content:
      " 1–2 cups of rinsed lentils (mix different types of lentils for a more diverse texture), 0.5 tsp turmeric powder, 1.5 tsp salt, 3.5 cups water, 4 large garlic cloves, crushed, 1 inch ginger, crushed, 1 green chili, crushed, 1.5 tbsp ghee (or oil), 1 tsp cumin seeds, 1 tbsp coriander seeds, crushed, 2 cloves, 1 medium red onion, chopped, 2 medium tomatoes chopped (or tomato puree / paste), 0.5 tsp coriander powder, ¼ tsp garam masala, ¼ tsp red chili powder, 2 tbsp cilantro, chopped, 1 tsp dried fenugreek leaves, crushed",
  },
  {
    id: 255,
    directory: "Recipes",
    title: "Indian ghee",
    slug: "/recipes/indian-ghee",
    dateCreated: "2026-01-01",
    content:
      "Love the nutty taste and flavor! Bonus points as it can be made out of stale butter. 1 kg beurre à température ambiante",
  },
  {
    id: 256,
    directory: "Recipes",
    title: "Indian pav bhaji",
    slug: "/recipes/indian-pav-bhaji",
    dateCreated: "2020-10-10",
    content:
      " 4 tbsp coriander seeds, 2 tbsp cumin seeds, 5 dried red chilies (adjust to taste), 8 cloves, 1 tbsp fennel seeds, 1/2 tsp black cardamon seeds (or 24 seeds), 5&nbsp;cm cinnamon stick, 1.5 tsp turmeric powder, 2 tsp ground black pepper, 1/2 tsp ground ginger, 2 tsp salt",
  },
  {
    id: 257,
    directory: "Recipes",
    title: "Italian arancini",
    slug: "/recipes/italian-arancini",
    dateCreated: "2022-12-08",
    content: " Pre-cooked risotto, ideally from the day before",
  },
  {
    id: 258,
    directory: "Recipes",
    title: "Italian bolognese",
    slug: "/recipes/italian-bolognese",
    dateCreated: "2023-01-01",
    content:
      "This is Valentina's family recipe. Her great-grandma used to make her own tomato paste from scratch. Her grandma reviewed the recipe with some store-bought tomato paste, which works just fine. The secret is chopping the vegetables into super tiny pieces and using tomato paste instead of tomato sauce. 250 g ground beef, 250 g ground pork, 3–4 celery stalks, finely chopped, 3–4 carrots, finely chopped, 1 big onion, finely chopped, 80–100 ml of white wine, 80 g butter + 2–3 spoons olive oil (or 100 g butter with no oil or just olive oil), Tomato paste, ideally the one with added celery and carrots",
  },
  {
    id: 259,
    directory: "Recipes",
    title: "Italian cacio e pepe",
    slug: "/recipes/italian-cacio-e-pepe",
    dateCreated: "2021-02-25",
    content:
      "I love the one-pan hack of this super creamy cacio e pepe! Spaghetti, Water, Salt, Pecorino (or parmesan), Black pepper, freshly ground",
  },
  {
    id: 260,
    directory: "Recipes",
    title: "Italian carbonara",
    slug: "/recipes/italian-carbonara",
    dateCreated: "2022-11-12",
    content:
      "Matteo and Valentina introduced Robin and I to an authentic carbonara recipe. It is apparently only one of many subtle variations, as they argued over many details during the cooking process. Just loved learning it with a glass of red wine! 1 pack of tonnarelli, spaghetti, mezze maniche or rigatoni, 200 g guanciale or rindless bacon, 1 cup grated Pecorino Romano (or Parmigiano Reggiano), 3 egg yolks + 1–2 entire eggs, Salt and black pepper",
  },
  {
    id: 261,
    directory: "Recipes",
    title: "Italian gnocchi",
    slug: "/recipes/italian-gnocchi",
    dateCreated: "2019-05-24",
    content:
      " 500 g pomme de terre, 250 g farine, 1 jaune d'œuf, Sel, 1 pincée muscade, 1 noisette de beurre",
  },
  {
    id: 262,
    directory: "Recipes",
    title: "Italian lasagna",
    slug: "/recipes/italian-lasagna",
    dateCreated: "2023-02-04",
    content:
      " 1 paquet de lasagnes sèches, 0.5 l de sauce bolognaise, 0.5 l de sauce béchamel, 1 oignon, émincé, 2 gousses d'ail, Poivre, Sel",
  },
  {
    id: 263,
    directory: "Recipes",
    title: "Italian pesto alla trapanese",
    slug: "/recipes/italian-pesto-alla-trapanese",
    dateCreated: "2023-06-10",
    content:
      "I discovered this pasta sauce recipe, as I was traveling with friends through Sicily in 2023. It is fresh, tomato-ey, and just perfect for summer. 3 medium cloves garlic, A big handful of almonds, blanched and peeled, A bouquet of basil, leaves only, 100 g Pecorino cheese (plus more for serving), 500 g plum tomatoes (meaty ones), seeded, Olive oil, Busiate pasta (for the traditional Trapanese recipe, but any pasta will do), Salt",
  },
  {
    id: 264,
    directory: "Recipes",
    title: "Italian ravioli",
    slug: "/recipes/italian-ravioli",
    dateCreated: "2022-10-11",
    content:
      " 220 g flour, 2 medium eggs, egg white-water mixture (only water works too)",
  },
  {
    id: 265,
    directory: "Recipes",
    title: "Italian ribollita",
    slug: "/recipes/italian-ribollita",
    dateCreated: "2020-06-24",
    content:
      "Robin and I discovered ribollita during our tandem bike trip in the Chianti region. We actually rarely use the traditional ingredients, but we love the concept of using up any kinds of vegetables and old bread you have on hand to create a filling soup. ½ lb. dried cannellini beans (1 ⅓ cups), ⅓ cup side-virgin olive oil, ½ onion, 1 carrot, 1 celery stalk, 1 garlic clove, 2-3 thyme sprigs (leaves only), 1 tsp salt, 1 potato, medium sized, ½ lb. lacinato kale (roughly a bunch), ½ head Savoy cabbage (about ¾ lb.), ⅓ lb. Swiss chard, 1 tbsp tomato paste (or ⅓ cup of canned diced tomatoes or 1 fresh tomato), ½ lb. whole wheat, rustic, stale bread, To taste, freshly ground black pepper",
  },
  {
    id: 266,
    directory: "Recipes",
    title: "Italian taralli",
    slug: "/recipes/italian-taralli",
    dateCreated: "2022-12-11",
    content:
      "I finally made my own taralli after trying them multiple times in Italian bars with Valentina, Matteo and Robin. 550 g plain flour, 10 g (or 2 tsp) salt, to taste, 120 g side virgin olive oil, 200 g dry white wine",
  },
  {
    id: 267,
    directory: "Recipes",
    title: "Italian tiramisu",
    slug: "/recipes/italian-tiramisu",
    dateCreated: "2022-11-20",
    content:
      "Tiramisu must be one of my favorite desserts. Beware the day I'll own an espresso machine, I'll be making tiramisu all the time. 20 biscuits à la cuillère, 75 g sucre, 250 g mascarpone, 2–3 oeufs, 50 cl café fort refroidi",
  },
  {
    id: 268,
    directory: "Recipes",
    title: "Italian veggie schiaccata",
    slug: "/recipes/italian-veggie-schiaccata",
    dateCreated: "2023-09-26",
    content:
      "Great to eat as a side or even as a main dish with some accompanying sauce. Some veggies (e.g. 2 carrots, 2 zucchini), grated, 1 potato, grated, 200 g flour, Salt, Olive oil",
  },
  {
    id: 269,
    directory: "Recipes",
    ...
    dateCreated: "2023-07-31",
    content:
      "I love Robin's family jam recipe. The result is not too sweet, syrupy with big pieces of fruits left. 5 kg fruit (e.g. apricots, prunes, cherries, etc.), 2.5 kg brown sugar",
  },
  {
    id: 270,
    directory: "Recipes",
    title: "Japanese pickled ginger",
    slug: "/recipes/japanese-pickled-ginger",
    dateCreated: "2022-10-06",
    content:
      " 1 kg fresh, young ginger roots, 2 tsp salt, 3 cups rice vinegar, 2 cups sugar",
  },
  {
    id: 271,
    directory: "Recipes",
    title: "Korean kimchi stew (kimchijigae)",
    slug: "/recipes/korean-kimchi-stew",
    dateCreated: "2019-01-27",
    content:
      " 1 pound kimchi, cut into bite size pieces, 1/4 cup kimchi brine, 1/2 pound pork shoulder (or pork belly), 1/2 package tofu, slices of 1&nbsp;cm thick, 3 green onions, 1 medium onion, sliced, 1 tsp salt, 2 tsp sugar, 2 tsp gochugaru (Korean hot pepper flakes), 1 tbsp gochujang (Korean hot pepper paste), 1 tsp toasted sesame oil, 2 cups anchovy stock",
  },
  {
    id: 272,
    directory: "Recipes",
    title: "Korean kimchi",
    slug: "/recipes/korean-kimchi",
    dateCreated: "2022-02-10",
    content:
      "I love fermenting stuff. Kimchi is one of the first fermenting recipes I learned. It is the perfect addition to any dish you want to brighten or spice a bit. 700 g cabbage, chopped, 3 tbsp salt, water, ginger, minced, garlic, crushed, onion, minced, leek, chopped, green onion, diagonally sliced, carrot, julienned",
  },
  {
    id: 273,
    directory: "Recipes",
    title: "Korean kimchijeon",
    slug: "/recipes/korean-kimchijeon",
    dateCreated: "2023-04-05",
    content:
      " 200 g kimchi, 2 tbsp kimchi brine, 3 scallions, chopped, 0.5 tsp sugar, 60 g flour, 100 g water (start with less, add if needed)",
  },
  {
    id: 274,
    directory: "Recipes",
    title: "Korean side-spinach (sigeumchi namul)",
    slug: "/recipes/korean-side-spinach",
    dateCreated: "2020-11-15",
    content:
      " 8 ounces spinach, cleaned and washed, 1 garlic clove, minced, 1 green onion, chopped, 1.5 tsp soy sauce, 1.5 tsp toasted sesame oil, 2 tsp toasted sesame seeds",
  },
  {
    id: 275,
    directory: "Recipes",
    title: "Korean steamed eggs (gyeran-jjim)",
    slug: "/recipes/korean-steamed-eggs",
    dateCreated: "2022-01-08",
    content: " 4 large eggs, 3/4 cup (180 g) water, 1 tsp salt",
  },
  {
    id: 276,
    directory: "Recipes",
    title: "Lacto fermented veggies",
    slug: "/recipes/lacto-fermentated-veggies",
    dateCreated: "2022-08-15",
    content: " Veggies (cut into pieces), Water, Salt",
  },
  {
    id: 277,
    directory: "Recipes",
    title: "Leek pie",
    slug: "/recipes/leek-pie",
    dateCreated: "2022-11-30",
    content:
      " 1 pâte brisée, 2 poireaux, 200 g crème fraîche ou yaourt, 2–4 oeufs, Poivre, sel, muscade",
  },
  {
    id: 278,
    directory: "Recipes",
    title: "Lemon bars",
    slug: "/recipes/lemon-bars",
    dateCreated: "2021-01-21",
    content: " 250 g flour, 100 g sugar, 230 g butter (diced)",
  },
  {
    id: 279,
    directory: "Recipes",
    title: "Lemon pie",
    slug: "/recipes/lemon-pie",
    dateCreated: "2022-03-14",
    content:
      " Pâte brisée précuite, 4 gros citrons bio (pour obtenir 150 ml de jus), 3 oeufs, 115 g de sucre, 30 g de beurre doux, 1 cuillère à soupe de maïzena",
  },
  {
    id: 280,
    directory: "Recipes",
    title: "Lemon risotto",
    slug: "/recipes/lemon-risotto",
    dateCreated: "2022-03-04",
    content:
      " 2 shallots, 1 stick of celery, 60 g unsalted butter, 1 tbsp olive oil, 300 g risotto rice, 1 l vegetable stock, zest and juice of half a lemon, 2 small sprigs of fresh rosemary (finely chopped), 1 large egg yolk, 4 tbsp grated Parmesan cheese (plus more to sprinkle), 60 ml double cream, salt (to taste), pepper (preferably white)",
  },
  {
    id: 281,
    directory: "Recipes",
    title: "Lentil galette",
    slug: "/recipes/lentil-galette",
    dateCreated: "2023-10-12",
    content:
      " 1 cup red lentils, 1 cup water (+ more for soaking lentils), 1 tbsp oil, Salt",
  },
  {
    id: 282,
    directory: "Recipes",
    title: "Miso butter",
    slug: "/recipes/miso-butter",
    dateCreated: "2023-10-12",
    content:
      " 6 tbsp butter, cut into pieces (at room temperature), 3 tbsp miso",
  },
  {
    id: 283,
    directory: "Recipes",
    title: "Orange loaf cake",
    slug: "/recipes/orange-loaf-cake",
    dateCreated: "2022-02-10",
    content:
      " 190 g all-purpose flour, 1 tsp baking powder (or Natron if we use some side sourdough starter), 0.5 tsp salt, 190 g sugar, 170 g butter, at room temperature, 2 large eggs, 5+ tbsp orange juice (or juice of half an orange), 1 orange zest, 250 ml sour cream",
  },
  {
    id: 284,
    directory: "Recipes",
    ...
    content: " Oats, Oat milk or cow milk, Honey (to taste)",
  },
  {
    id: 285,
    directory: "Recipes",
    title: "Pad thai",
    slug: "/recipes/pad-thai",
    dateCreated: "2023-09-22",
    content:
      " 40 g tamarind pulp, 1/2 cup boiling water, 3 tbsp sugar, 3 tbsp fish sauce, 2 tbsp dark soy sauce, Pepper (to taste)",
  },
  {
    id: 286,
    directory: "Recipes",
    title: "Pain perdu",
    slug: "/recipes/pain-perdu",
    dateCreated: "2022-11-09",
    content: " 25 cl lait, 50 g sucre, 3 oeufs, 6 épaisses tranches de pain",
  },
  {
    id: 287,
    directory: "Recipes",
    title: "Pasta dough",
    slug: "/recipes/pasta-dough",
    dateCreated: "2022-10-11",
    content:
      " 330 g all-purpose flour or ideally semolina (adjust until right consistency), >3 medium eggs",
  },
  {
    id: 288,
    directory: "Recipes",
    title: "Pasta with bean sauce",
    slug: "/recipes/pasta-with-bean-sauce",
    dateCreated: "2020-06-24",
    content:
      "A pasta sauce made of beans only? Yep, it is apparently possible and surprisingly good. 0.5 cup side-virgin olive oil, 1 cup walnuts, finely chopped, 0.5 tsp crushed red pepper flakes, 5 garlic cloves — 1 whole, 4 thinly sliced, 1 sprigs rosemary, 1 can white beans, 1.5 cup large tubular pasta, salt, 1 lemon, 2 tbsp finely chopped parsley, ground black pepper",
  },
  {
    id: 289,
    directory: "Recipes",
    title: "Pâte brisée",
    slug: "/recipes/pate-brisee",
    dateCreated: "2023-06-30",
    content: " 210 g blé, 115 g beurre, 0.5 c-à-c sel, 60 ml eau",
  },
  {
    id: 290,
    directory: "Recipes",
    title: "Peach ice tea",
    slug: "/recipes/peach-ice-tea",
    dateCreated: "2023-08-08",
    content: " 3+ peaches, 2 tbsp black tea leaves, 1 l water",
  },
  {
    id: 291,
    directory: "Recipes",
    title: "Persian rice pilaf (sabzi polo)",
    slug: "/recipes/persian-rice-pilaf",
    dateCreated: "2022-11-09",
    content:
      "One of my go-to recipes for when I have a lot of parsley I want to finish. 2 cups basmati rice, 8.25 cups water (to cook the rice), 5 cups fresh herbs (dill, parsley, cilantro), thinly chopped, 12 cloves garlic, coarsely chopped, 3 tbsp salt, 4 tbsp vegetable oil",
  },
  {
    id: 292,
    directory: "Recipes",
    title: "Pie dough",
    slug: "/recipes/pie-dough",
    dateCreated: "2021-01-21",
    content:
      " 250 g farine T55 ou autre, 50 g huile, 80 g eau tiède, 1 pincée de sel",
  },
  {
    id: 293,
    directory: "Recipes",
    title: "Polish vegetarian cabbage rolls",
    slug: "/recipes/polish-vegetarian-cabbage-rolls",
    dateCreated: "2021-01-19",
    content:
      " 1 large cabbage, 2 cups brown rice, cooked, 1 lb veggie crumbles, 0.5 cup onion, minced, 1 garlic clove, minced, 1 tsp ground ginger, 1 tbsp sweet paprika, 1 tbsp parsley, chopped, 1 tsp black pepper, 2 eggs, 0.5 cup vegetable broth, 2 tbsp olive oil, 1 can diced tomatoes, 1 can tomato soup",
  },
  {
    id: 294,
    directory: "Recipes",
    title: "Potato gratin",
    slug: "/recipes/potato-gratin",
    dateCreated: "2022-10-31",
    content: " Potatoes, Milk, Flour, Butter, Cheese",
  },
  {
    id: 295,
    directory: "Recipes",
    title: "Potato soup",
    slug: "/recipes/potato-soup",
    dateCreated: "2023-03-01",
    content:
      " 8 pommes de terre de taille moyenne, 5 carottes de taille moyenne, 40 g de chorizo (ou autre saucisse séchée), 4 poignées de feuilles d'épinards, 1 oignon, 1 gousse d'ail pressée, Bouillon, Huile, Sel et poivre",
  },
  {
    id: 296,
    directory: "Recipes",
    title: "Puff pastry",
    slug: "/recipes/puff-pastry",
    dateCreated: "2022-12-15",
    content:
      "This puff pastry recipe doesn't result in as many layers as a store-bought dough, but it does the job with minimal effort. 250 g plain flour, 280 g butter, very cold, 0.5 tsp salt, 120 ml of ice-cold water",
  },
  {
    id: 297,
    directory: "Recipes",
    title: "Rice pilaf",
    slug: "/recipes/rice-pilaf",
    dateCreated: "2023-02-03",
    content:
      " Long grain rice, 1 onion, sliced, 2 garlic cloves, sliced, Vegetables, diced, 0.5 tsp coriander, 1 tsp paprika, 1 tsp Aleppo pepper, 1 tsp ground turmeric",
  },
  {
    id: 298,
    directory: "Recipes",
    ...
    dateCreated: "2022-11-22",
    content: " vegetables, Olive oil",
  },
  {
    id: 299,
    directory: "Recipes",
    title: "Shortbread",
    slug: "/recipes/shortbread",
    dateCreated: "2021-02-14",
    content:
      " 240 g butter at room temperature, 120 g sugar, 360 g flour, 1 pod vanilla, seeds scraped out, 0.5 tsp flaky sea salt",
  },
  {
    id: 300,
    directory: "Recipes",
    ...
    dateCreated: "2022-04-03",
    content:
      " 1 tbsp paprika, 1 tsp chili powder, 500 g sauerkraut, 4 potatoes, peeled and chopped bite-size, 2 carrots, peeled and chopped bite-size, 3 cloves garlic, sliced, 1 onion, diced, 2–3 pickled cucumbers, sliced, 1 stock cube, oil, pepper and salt",
  },
  {
    id: 301,
    directory: "Recipes",
    title: "Solid deodorant",
    slug: "/recipes/solid-deodorant",
    dateCreated: "2021-04-11",
    content:
      "This is the DIY deodorant recipe I have been using for many years now. Simple and effective. 60 g huile de coco bio, 48 g bicarbonate de soude, 30 g fécule de maïs, 24 gouttes huiles essentielles (palmarosa, tea tree, lavender)",
  },
  {
    id: 302,
    directory: "Recipes",
    title: "Solid shampoo",
    slug: "/recipes/solid-shampoo",
    dateCreated: "2023-10-15",
    content:
      " 50 g de SCI (Sodium Cocoyl Isethionate), 15 g  de poudre de plante adaptée à vos cheveux (ex : poudre de bhringaraj), 17 g de phase huileuse (huiles végétales ou beurres végétaux, ex : huile de coco), 15 g de phase aqueuse (hydrolat, infusion, macérat aqueux ou eau, ex : hydrolat de romarin à verbénone), 2 g d'acide citrique",
  },
  {
    id: 303,
    directory: "Recipes",
    title: "Sourdough bagels",
    slug: "/recipes/sourdough-bagels",
    dateCreated: "2021-01-22",
    content:
      " 125 g sourdough starter, 225 g water, 40 g honey (or sugar), 10 g fine salt, 500 g flour, 1 tbsp sugar (for boiling water)",
  },
  {
    id: 304,
    directory: "Recipes",
    title: "Sourdough burger buns",
    slug: "/recipes/sourdough-burger-buns",
    dateCreated: "2021-01-22",
    content:
      " 200 g levain, 300 g farine T45, 200 g farine semi-complète T110, 8 g sel, 16 g sucre, 200 g lait à température ambiante (ou eau), 60 g beurre mou, 1 oeuf",
  },
  {
    id: 305,
    directory: "Recipes",
    title: "Sourdough naan",
    slug: "/recipes/sourdough-naan",
    dateCreated: "2023-09-18",
    content:
      " 150 g water, 80 g yogurt, 75 g sourdough starter, 350 g flour, 0.5 tsp salt, 1.5 tbs sugar, 1 tbsp olive oil",
  },
  {
    id: 306,
    directory: "Recipes",
    title: "Stuffed vine leaves",
    slug: "/recipes/stuffed-vine-leaves",
    dateCreated: "2023-07-31",
    content:
      "France's recipe, perfect for quick out-of-the-freezer starters. 1 tasse d'huile d'olive, 2 c.à.s. de pignons de pin, 2 oignons émincés, 1/2 tasse de riz blanc, 1/4 tasse de raisins secs, sel et poivre, un peu de menthe, 1/2 tasse d'eau chaude, 30 feuilles de vigne fraîches, 1 citron",
  },
  {
    id: 307,
    directory: "Recipes",
    title: "Tarte tatin with summer veggies",
    slug: "/recipes/tarte-tatin-with-summer-veggies",
    dateCreated: "2023-07-24",
    content:
      " Pie dough, 2 tomatoes, 1 zucchini, thinly sliced, 1 onion, thinly sliced",
  },
  {
    id: 308,
    directory: "Recipes",
    title: "Tarte tatin",
    slug: "/recipes/tarte-tatin",
    dateCreated: "2023-09-13",
    content:
      " 1 pâte à tarte (feuilletée de préférence), 90 g de sucre, 1 c-à-s de miel, 1 c-à-s de vinaigre de cidre ou citron, 30 g de beurre, 1 grosse pincée de sel, 1 kg de pommes, coupées en quartiers, 1 sachet de sucre vanillé, Cannelle",
  },
  {
    id: 309,
    directory: "Recipes",
    title: "Thai red curry paste (prig gang ped)",
    slug: "/recipes/thai-red-curry-paste",
    dateCreated: "2022-07-10",
    content:
      " 1 tbsp cilantro roots (or stems), 1 tbsp coriander seeds, 0.5 tbsp cumin seeds, 3 dried whole chilis, 1.5 tbsp galangal roots, 35 g garlic, 1 stalk lemongrass, 0.5 tsp peppercorns, 1 tabs. salt, 80 g shallots, 1 tbsp keffir lime zest (or lime zest)",
  },
  {
    id: 310,
    directory: "Recipes",
    title: "Turnips with honey and zaatar",
    slug: "/recipes/turnip-with-honey-and-zaatar",
    dateCreated: "2023-03-06",
    content:
      "France's recipe: great as a side, can be eaten hot or cold. 1 turnip, Honey, Zaatar",
  },
  {
    id: 311,
    directory: "Recipes",
    title: "Vegetarian gravy (upgraded version)",
    slug: "/recipes/vegetarian-gravy-upgraded",
    dateCreated: "2022-12-06",
    content:
      " 1 tbsp oil, 3 cloves garlic, chopped, 1 onion, chopped, 1–2 small pre-boiled potatoes, 7 g dried mushrooms, 1/2 cup red wine, 1/4 tsp cayenne pepper, 1/4 tsp cumin, 1 tsp smoked paprika, 1.5 tbsp soy sauce, 1 cup vegetable broth, Shiitake mushrooms, to taste, 1 pinch of salt",
  },
  {
    id: 312,
    directory: "Recipes",
    title: "Vegetarian gravy",
    slug: "/recipes/vegetarian-gravy",
    dateCreated: "2022-02-10",
    content:
      " 8 tbsp oil, 1 onion, chopped, 3 cloves garlic, minced, 4 tbsp all-purpose flour, 2 tbsp light soy sauce, 1 cup vegetable broth, salt, black pepper, ground",
  },
  {
    id: 313,
    directory: "Recipes",
    title: "Veggie loaf",
    slug: "/recipes/veggie-loaf",
    dateCreated: "2022-11-20",
    content:
      "Recette de Souad, toute simple et goûtue. 110 g farine blanche, 110 g farine d'épeautre complète, 2 oeufs, 150 g lait, 40 g huile végétale, 0.5 cc bicarbonate, 1 cc vinaigre blanc, Sel et poivre",
  },
  {
    id: 314,
    directory: "Recipes",
    title: "Vietnamese cháo gà",
    slug: "/recipes/vietnamese-chao-ga",
    dateCreated: "2022-11-30",
    content:
      "Reminescent of childhood memories. Chao was my mother go-to recipe whenever someone in the family would get sick. 1 yellow onion, 1 whole chicken, 1 tbsp salt, 1.5 tbsp sugar, 250 g uncooked jasmine rice, 5&nbsp;cm knob fresh ginger, peeled and finely chopped, 1.5 tbsp fish sauce, 2 tsp freshly ground black pepper",
  },
  {
    id: 315,
    directory: "Recipes",
    title: "Vietnamese đồ chua",
    slug: "/recipes/vietnamese-do-chua",
    dateCreated: "2023-02-25",
    content:
      " Carrots, peeled and julienned, 2 cups water, 1 cup vinegar (can be a mix of rice, white or apple vinegar), 0.5 cup sugar",
  },
  {
    id: 316,
    directory: "Recipes",
    title: "Watermelon salad",
    slug: "/recipes/watermelon-salad",
    dateCreated: "2023-09-14",
    content:
      "A refreshing sweet and savory salad for hot summer days. Watermelon, Feta, Fresh mint",
  },
  {
    id: 317,
    directory: "Recipes",
    title: "Whole roasted cauliflower",
    slug: "/recipes/whole-roasted-cauliflower",
    dateCreated: "2022-10-06",
    content:
      " 2 small heads cauliflower, 2 btsp olive oil, 1.25 tsp flake salt",
  },
  {
    id: 318,
    directory: "Recipes",
    title: "Zucchini soup",
    slug: "/recipes/zucchini-soup",
    dateCreated: "2023-07-06",
    content:
      " Huile d'olive, 1 kg courgette, 2 oignons, 2 verres de lait et / ou eau, Sel et poivre",
  },
];
